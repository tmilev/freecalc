...
\subsection{Integration - Problem Collection}
\subsubsection{Indefinite Integrals} \label{secMPSIntegrationCollectionIndefinite}
\begin{problem}
...
\end{problem}
\subsubsection{Definite Integrals}\label{secMPSIntegrationCollectionDefinite}
\begin{problem}
