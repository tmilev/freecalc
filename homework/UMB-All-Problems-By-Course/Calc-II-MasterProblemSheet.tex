...
\begin{problem}
\input{../../modules/trig-substitution/homework/euler-substitution-theory-case2}
\end{problem}
...
\begin{problem}
\input{../../modules/trig-substitution/homework/euler-substitution-theory-case3}
\end{problem}
...
\begin{problem} \input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case1-cot}
\end{problem} 
\input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case1-cot-solution}

\begin{problem} \input{../../modules/trig-substitution/homework/euler-substitution-theory-alternative-case1-cot}
\end{problem} 
...
\begin{problem} \input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case1-tan}
\end{problem} 
\input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case1-tan-solution}
\begin{problem} \input{../../modules/trig-substitution/homework/euler-substitution-theory-alternative-case1-tan}
\end{problem} 

\subsection{Case 2: $\sqrt{1-x^2}$}
\subsubsection{$x=\cos \theta$}
\begin{problem} \input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-cos}
\end{problem} 
\input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-cos-solution}

\begin{problem} \input{../../modules/trig-substitution/homework/euler-substitution-theory-alternative-case1-cos}
\end{problem} 
...
\begin{problem} \input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-sin}
\end{problem} 
\input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-sin-solution}

\begin{problem} \input{../../modules/trig-substitution/homework/euler-substitution-theory-alternative-case1-sin}
\end{problem} 

\subsection{Case 3: $\sqrt{x^2-1}$}
\subsubsection{$x=\sec \theta$}
\begin{problem} \input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-sec}
\end{problem} 
\input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-sec-solution}

\begin{problem} \input{../../modules/trig-substitution/homework/euler-substitution-theory-alternative-case1-sec}
\end{problem} 
...
\begin{problem} \input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-csc}
\end{problem} 
\input{../../modules/trig-substitution/homework/trig-and-euler-substitution-theory-case2-csc-solution}

\begin{problem} \input{../../modules/trig-substitution/homework/euler-substitution-theory-alternative-case1-csc}
\end{problem} 
...
\begin{problem}
\input{../../modules/lhospital/homework/lhospital-rule-coming-from-Maclaurin-series-2}
\end{problem}
...
\end{problem}
\begin{problem}
\input{../../modules/series/homework/express-infinite-decimal-as-rational-2}
\end{problem}
\begin{problem}
...
\begin{problem}
\input{../../modules/series/homework/series-integral-or-comparison-test-3}
\end{problem}
\input{../../modules/series/homework/series-integral-or-comparison-test-3-solutions}

\begin{problem}
\input{../../modules/series/homework/series-integral-or-comparison-test-1}
\end{problem}
\begin{problem}
\input{../../modules/series/homework/series-integral-or-comparison-test-2}
\end{problem}

\subsubsection{Root, ratio tests}
\begin{problem}
\input{../../modules/series/homework/series-ratio-and-or-root-test-1}
\end{problem}
\begin{problem}
...
\begin{problem}
\input{../../modules/power-series/homework/interval-of-convergence-2}
\end{problem}
...
\end{problem}
\begin{problem}
\input{../../modules/power-series/homework/find-maclaurin-series-2}
\end{problem}
\begin{problem}
...
\begin{problem}
\input{../../modules/diff-eq-separable/homework/separable-DFQs-2}
\end{problem}
\begin{problem}
\input{../../modules/diff-eq-separable/homework/separable-DFQs-3}
\end{problem}
\input{../../modules/diff-eq-separable/homework/separable-DFQs-3-solutions}

\begin{problem}
\input{../../modules/diff-eq-separable/homework/separable-DFQs-4}
\end{problem}
