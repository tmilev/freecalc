...
\begin{enumerate}
\item (Lecture 7) \input{../../modules/inverse-functions/homework/inverse-functions4}
\item (Lecture 8) \input{../../modules/logarithms/homework/logarithms-equations3}
\item (Lectures 10-14)
\input{../../modules/product-quotient/homework/quotient-rule1}
\item (Lectures 10-14) \input{../../modules/chain-rule/homework/chain-rule7}
\item (Lectures 10-14) \input{../../modules/chain-rule/homework/chain-rule8}
\item (Lecture 15) \input{../../modules/implicit-differentiation/homework/implicitly-differentiate2}
\item (Lecture 17) \input{../../modules/maxima-minima/homework/maxima-minima-text-problems}
\item (Lecture 13)
\begin{enumerate}
