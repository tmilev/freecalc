...
\noindent The exam is closed textbook. The final exam will contain problems of types similar to the problem types given here. Each problem type given in this review sheet will be represented by at least one exam question. The final will contain 12 or more problems (in turn consisting in a number of sub-problems). 
