...
\item \textbf{This problem type may appear on the final or the test but will not appear on the quiz.} \input{../../modules/series/homework/geometric-series-sum-1}
...
\begin{comment}
\homeworkStart{on Lecture 18\\ Quiz date will be announced in class}{}
\item
