...
\input{../../lectures/example-templates} %warning this path is relative to the file that uses the \usepackage command, not relative to the style file.
\input{../../lectures/pstricks-commands} %warning this path is relative to the file that uses the \usepackage command, not relative to the style file.
