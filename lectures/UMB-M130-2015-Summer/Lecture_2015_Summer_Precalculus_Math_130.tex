...
\subsection{Trig Identities Based on $\sin^2\theta+\cos^2\theta=1$}
\input{../../modules/trig-identities-pythagorean-ex1}
\input{../../modules/trig-identities-pythagorean-ex2}
%\subsection{Trig Identities Based Angle sum formulas}
