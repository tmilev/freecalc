...
\usepackage{xr}
\IfFileExists{../../homework/UMB-All-Problems-By-Course/Calc-I-MasterProblemSheet}{
...
\newcommand{\websitebase}{https://piazza.com/umb/spring2017/math140}

\usepackage{pdfpages}

\title{\vskip -2cm 
 Math 140 Calculus I \\ Spring 2017}
\date{}
\begin{document}
%\color{green}
\maketitle
...
Todor Milev & Office hours: 12:00-13:45 Monday and Wednesday or by appointment. Room: S-03-65.\\
\end{tabular}
...
\medskip
\noindent \textbf{Quizzes homework and on-line homework.} You primary homework consists of problems assigned through an on-line homework system located here:

\url{https://calculator-algebra.org/cgi-bin/calculator}

\noindent You will also be given a supplementary \textbf{non-mandatory} homework, in case you wish to get additional problem solving practice. The supplementary homework can be found here:

\url{\websitebase/resources}

\noindent  The conventional homework problems are not going to be collected, proofread or graded.

\medskip



\medskip\noindent \textbf{Textbook. } There are two official textbooks for this course. It is  \textbf{mandatory} to have access to \textbf{at least one of the textbooks}. Having only one of the two textbooks is sufficient to complete the course. No homework will be assigned from either textbook. The purpose of the textbook is to supplement the lecture slides and provide more details.
