...
\title[\insertlecture]{\hspace{-1.3cm} {\raisebox{-0.7cm}[0cm][0cm]{ \includegraphics[height =1.2cm]{../University-Logos/UMass-logo-blue.png}}} Math 141}
\subtitle{\insertlecture}
\author[{\raisebox{-0.115cm}{\includegraphics[height=0.4cm]{../University-Logos/UMass-logo-blue.png}}} FreeCalc \\ Math 141]{\begin{tabular}{rl}Authors: & the freecalc project team\\ Instructors:& Ricardo Castano-Bernard\\&  Todor Milev \end{tabular}}
...
%DesiredLectureName: Alternating_Series_Absolute_Convergence_Raio_Root_Tests
\fcLicense
...
%DesiredLectureName: Polar_Coordinates_Complex_Numbers
\fcLicense
