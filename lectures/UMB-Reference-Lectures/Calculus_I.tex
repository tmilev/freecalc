...
\title[\textbf{\color{green}{\insertlecture}}]{\hspace{-1.3cm} {\raisebox{-0.7cm}[0cm][0cm]{ \includegraphics[height =1.2cm]{../University-Logos/UMass-logo-blue.png}}} Math 140, Calculus I \\ \insertlecture }

\author[\raisebox{-0.115cm}{\includegraphics[height=0.4cm]{../University-Logos/UMass-logo-blue.png}} Todor Milev]{\Large \\
\normalsize Reference Lectures\\Todor Milev\\ 
...
%\input{../../modules/integration/summation-notation-and-riemann-sums}
