...
\title[\textbf{\color{green}{\insertlecture}}]{\hspace{-1.3cm} {\raisebox{-0.7cm}[0cm][0cm]{ \includegraphics[height =1.2cm]{../University-Logos/UMass-logo-blue.png}}} Math 141, Calculus II \\ \textbf{\color{green}{ \insertlecture}} }
...
%DesiredLectureName: Surface_Area_Solid_of_Revolution
