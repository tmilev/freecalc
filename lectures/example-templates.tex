...
\FPeval{\fcResult}{clip(#2-1)}
\uncover<handout:0|#1-\fcResult>{\alert<handout:0|\fcResult>{\textbf{?}}} \uncover<handout:0|#2->{\alert<handout:0|#2>{\!\!\!#3}}
}
...
\FPeval{\fcResult}{clip(#1-1)}
\only<handout:0|-\fcResult>{#2} \only<#1->{\alertNoH{#1}{\cancel{#2}}}
\vphantom{\cancel{#2}}
}
...
& \uncover<3->{%
 = \left( #1 \right) \alert<handout:0| 3-4>{\left(\fcAnswer{4}{ #4 }\right)} + \left( #2 \right) \alert<handout:0| 5-6>{\left( \fcAnswerUncover{3}{6}{#3} \right)}%
}\\%
& \uncover<7->{%
 = #5.%
}%
...
& \uncover<5->{%
 =  \left( #3\right)\alert<handout:0| 5-6>{\left( \fcAnswer{6}{#5}\right)}
}\\%
& \uncover<7->{%
 =  #6.
}%
...
& \uncover<3->{%
 = \frac%
{\left( #2 \right) \alert<handout:0| 3-4>{\left(\fcAnswer{4}{ #3 }\right)} - \left( #1 \right) \alert<handout:0| 5-6>{\left( \fcAnswerUncover{3}{6}{#4} \right)}}%
{\left( #2\right)^2}%
}\\%
& \uncover<7->{%
 = #5%
...
&& \uncover<7-|handout:0>{=}&\displaystyle \uncover<7-|handout:0>{\alertNoH{7-8}{\left( \uncover<8-| handout:0>{\noexpandarg\exploregroups\StrSubstitute{#4}{UU}{\alertNoH{11}{u}}\noexploregroups\expandarg}\right)}%
\alertNoH{9-10}{\left( \uncover<10-| handout:0>{#5}\right)}%
}\\%
&& \uncover<11-|handout:0>{ = }&\displaystyle \uncover<11-| handout:0>{%
...
&& \uncover<handout:0|7->{ =}&\displaystyle \uncover<handout:0|7->{ \alertNoH{7-8}{ \left( \uncover<8-| handout:0>{\noexpandarg \exploregroups \StrSubstitute{#4}{UU}{\alert<handout:0| 11>{u}} \noexploregroups\expandarg}\right)}%
\alertNoH{9-10}{\left( \uncover<10-| handout:0>{#5}\right)}%
}\\%
...
{%
\alert<handout:0| 12-13>{( \fcAnswerUncover{12}{13}{%
\StrMid{#9}{2}{2}%
})}%
\alert<handout:0| 14-15>{(\fcAnswerUncover{12}{15}{%
\StrMid{#9}{3}{3}%
})}%
}{%
\alert<handout:0| 16-17>{(\fcAnswerUncover{12}{17}{%
\StrMid{#9}{4}{4}%
})}%
\alert<handout:0| 18-19>{(\fcAnswerUncover{12}{19}{%
\StrMid{#9}{5}{5}%
})}%
}%
}%
}\\%
& \uncover<20->{\alert<handout:0| 20-21>{ = \fcAnswer{21}{(\alertNoH{22}{ \StrMid{#9}{6}{6}})}}}\\%
\uncover<22->{%
...
\uncover<4->{\text{Chain Rule:} \ \ \quad &= \alert<handout:0|4-5>{\left(\fcAnswerNoH{5}{#2} \right)\alert<handout:0|6-8>{\frac{\diff}{\diff x} \left(\uncover<4-| handout:0>{#3}\right)}}} \\%
\uncover<7->{\text{Chain Rule:} \ \ \quad &= \left(\uncover<7-| handout:0>{#2}\right) \alert<handout:0|7-8>{\left(\fcAnswerNoH{8}{#4}\right) \alert<handout:0|9-10>{\frac{\diff}{\diff x}\left( \uncover<7-| handout:0>{#5} \right)}}}\\%
\uncover<9->{\uncover<10->{\ifthenelse{\equal{#7}{}}{}{\text{#7 :} \ \ \quad}}& = \left(\uncover<9-| handout:0>{#2} \right) \left(\uncover<9-| handout:0>{#4}\right)\alert<handout:0|9-10>{\left( \fcAnswerNoH{10}{#6} \right) }} \\%
