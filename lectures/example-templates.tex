...
\frac{1}{\alertNoH{12}{y}} y'%
 ...
 & \uncover<8->{ = } %
\uncover<8->{%
( #2 ) \alertNoH{8-9}{\left( \uncover<9->{ #3 }\right)} + \left( \ln #1 \right) \alertNoH{ 10-11}{ \left( \uncover<11->{ #4 } \right) }
}\\%
\uncover<12->{%
y'%
}%
...
& \uncover<2->{%
 = \left( #1 \right) \alertNoH{ 3-4}{\frac{\diff}{\diff x}\left( #2 \right)} + \left( #2 \right) \alertNoH{ 5-6}{\frac{\diff}{\diff x}\left( #1 \right)}%
}\\%
& \uncover<3->{%
 = \left( #1 \right) \alertNoH{ 3-4}{\left(\fcAnswer{4}{ #4 }\right)} + \left( #2 \right) \alertNoH{ 5-6}{\left( \fcAnswerUncover{3}{6}{#3} \right)}%
}\\%
& \uncover<7->{%
 = #5.%
}%
...
& \uncover<2->{%
 = \frac%
{\left( #2 \right) \alertNoH{ 3-4}{\frac{\diff}{\diff x}\left( #1 \right)} - \left( #1 \right) \alertNoH{ 5-6}{\frac{\diff}{\diff x}\left( #2 \right)}}%
{\left( #2\right)^2}%
}\\%
& \uncover<3->{%
 = \frac%
{\left( #2 \right) \alertNoH{ 3-4}{\left(\fcAnswer{4}{ #3 }\right)} - \left( #1 \right) \alertNoH{ 5-6}{\left( \fcAnswerUncover{3}{6}{#4} \right)}}%
{\left( #2\right)^2}%
}\\%
& \uncover<7->{%
 = #5%
...
\uncover<7-| handout:0>{\alertNoH{ 7-8}{ \left( \uncover<8-| handout:0>{\noexpandarg \exploregroups \StrSubstitute{#4}{UU}{\alertNoH{ 11}{h(x)}} \noexploregroups\expandarg}\right)}%
