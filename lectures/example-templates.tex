...
%Example:
%\uncover<-5>{}% to ensure uncovering of the whole picture
...
\uncover<handout:0|\the\numexpr#1+7\relax>{%
\parametricplot[linecolor=brown, linewidth=2pt, plotpoints=500, arrows=->]{0}{theOtherAngle 360 add}{t cos 0.5 t 3000 div add mul t sin 0.55 t 3000 div add mul}%
}%
