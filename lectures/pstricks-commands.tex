...
%(before fcGet point ...) == pstack
\fcGetPointOnPlaneThatProjectsToXYCode 
%(after fcGet point...: ) ==
%pstack 
%\fcLightSource\space pop \fcDistance  1 exch div 
%(got to here, color is: ) ==
%currentColor  ==
[ exch dup \fcScreen\space pop \fcVectorScalarVector 
\fcVectorTimesScalar {abs 10 mul}forall ] 
%(theColor: ) ==
%dup == 
\fcColorToColorStringCode
