...
\newcommand{\fcTickSizeToLengthRatio}{0.05}
...
\define@key{fcGraphics}{ticksizeToLengthRatio}[\renewcommand{\fcTickSizeToLengthRatio}{0.05}]{\renewcommand{\fcTickSizeToLengthRatio}{#1}}
...
\newcommand{\fcLengthIndicatorNoLabel}[5][]{%
\setkeys{fcGraphics}{#1}%
\pstVerb{5 dict begin
/oV [#3 #5 sub #4 #2 sub] def 
/nV oV \fcVectorNormalize def
/nVscaled nV \fcTickSizeToLengthRatio\space \fcVectorTimesScalar def
}%
