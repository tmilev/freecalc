...
\newcommand{\fcYTick}[1]{\psline(! -\fcTickSize #1)(! \fcTickSize #1)}
...
\psline[linecolor=red, #1](! [#2 #3] nVscaled \fcVectorMinusVector \fcArrayToStack)(! [#2 #3] nVscaled \fcVectorPlusVector \fcArrayToStack)%
\psline[linecolor=red, #1](! [#4 #5] nVscaled \fcVectorMinusVector \fcArrayToStack)(! [#4 #5] nVscaled \fcVectorPlusVector \fcArrayToStack)%
