...
\newcommand{\fcShFillCode}{
gsave % save graphics state
clip % clip to constructed path
%newpath % clear out current path
% Define the shading and function dictionaries
<< 
/Domain [ [getZBufferXmin getZBufferYmin] \fcCoordsPStricksToPS  [getZBufferXmax  getZBufferYmax] \fcCoordsPStricksToPS 3 -1 roll exch]
/Matrix [1 0 0 1 0 0]
 /ShadingType 1
...
/shfillVirtual {\fcShFillCode} def
/arrowVirtual {} def
