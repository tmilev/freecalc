...
\begin{pspicture}(-0.4,0.4)(2.3,2.2)
\tiny 
\psaxesStandard{-0.3}{-0.3}{2.146803}{1.994800}
%\theCurve is defined in the beginning of this module, has limited scope
\parametricplot{\lowBound}{\highBound}{\theCurve}
\uncover<2-4>{%
\polylineAlongCurveWithLabels[linecolor=\psColorGraph]{3}{\lowBound}{\highBound}{\theCurve}{P}%
}
\uncover<5>{%
\polylineAlongCurveWithLabels[linecolor=\psColorGraph]{4}{\lowBound}{\highBound}{\theCurve}{P}%
}
\uncover<6>{%
\polylineAlongCurveWithLabels[linecolor=\psColorGraph]{5}{\lowBound}{\highBound}{\theCurve}{P}%
}
\uncover<6>{%
\polylineAlongCurveWithLabels[linecolor=\psColorGraph]{6}{\lowBound}{\highBound}{\theCurve}{P}%
}
\uncover<7>{%
\polylineAlongCurveWithLabels[linecolor=\psColorGraph]{10}{\lowBound}{\highBound}{\theCurve}{P}%
}
\uncover<8->{%0
\polylineAlongCurveWithLabels[linecolor=\psColorGraph]{14}{\lowBound}{\highBound}{\theCurve}{P}%
}
\end{pspicture}
%\ \only<handout:0| -1>{%
