...
\[
\begin{array}{rcll|l}
A&=&\displaystyle\int_{-2}^{1}\left|x^2-(2x^2+x-2) \right|\diff x&&x^2>(2x^2+x-2) \text{ for }x\in [-2,1] \text{ (from plot)}\\
&=&\displaystyle\int_{-2}^{1}\left(x^2-(2x^2+x-2) \right)\diff x\\
