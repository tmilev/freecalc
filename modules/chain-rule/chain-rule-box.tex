...
\uncover<9->{%
 = \left( \sec^2 \alertNoH{ 10}{\square} \right) \alertNoH{ 10}{\square}'%
}%
\uncover<10->{%
 = \left( \sec^2 ( \alertNoH{ 10}{x^3} )\right) \alertNoH{ 10-11}{(x^3)}\alertNoH{ 11}{'}%
}%
\uncover<11->{%
 = \alertNoH{ 11}{3x^2} \sec^2 \left( x^3 \right)
}%
\]
\end{example}
}%
