...
\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-1}
\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-1-1}

\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-2}
\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-2-1}
...
\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-13}
\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-14}
\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-15}
\item \input{\freecalcBaseFolder/modules/chain-rule/homework/chain-rule1-problem-16}
\item $5^{x}$.
