...
\uncover<6->{\fcPutIIId[t]{[2 1 0.9]}{\alertNoH{6}{$x_B- x_A$}}}%
\uncover<7->{\fcPutIIId[tl]{[3 2.5 1]}{\alertNoH{7}{$~~y_B- y_A$}}}%
\uncover<8->{\fcPutIIId[l]{[3 4 2]}{\alertNoH{8}{$~~z_B- z_A$}}}%
\end{pspicture}
\column{0.6\textwidth}
\uncover<2->{Why is this so? Geometric explanation:}
\[
\begin{array}{r@{}c@{}ll|l}
\uncover<3->{\alertNoH{5}{|AC|^2} &~\alertNoH{5}{=}~& \alertNoH{5}{|AD|^2+|DC|^2} &&  \alertNoH{3}{\triangle ADC}\\}
\uncover<4->{|AB|^2 &~=~&  |BC|^2+\alertNoH{5}{|AC|^2}&& \alertNoH{4}{ \triangle ACB}\\}
\uncover<5->{&~=~&|\alertNoH{8}{BC}|^2+\alertNoH{5}{|\alertNoH{6}{AD}|^2+|\alertNoH{7}{DC}|^2} \\}
\uncover<6->{&~=~&\phantom{+} (\alertNoH{6}{x_B-x_A})^2+(\alertNoH{7}{y_B-y_A})^2\\
&&+(\alertNoH{8}{z_B-z_A} )^2\quad ,}
\end{array}
\]
\end{columns}
...
%
\uncover<9->{
Example: \[d(P(3,1,2), Q(1,2,3)) =  \fcAnswer{10}{ \sqrt{(1-3)^2+(2-1)^2+(3-2)^2} = \sqrt{6} }\quad .\]
}
