...
\end{enumerate}
\uncover<2->{%
The domain of the function is $\fcAnswer{3}{(-\infty , -1) \cup (-1, 1)\cup (1,\infty ).}$
}%
\end{columns}
\end{example}
...
\]
\uncover<6->{Therefore $f$ is \fcAnswer{ 7}{even}.}
\end{columns}
\end{example}
...
\[
\begin{array}{r@{}c@{}l}
\displaystyle \alertNoH{ 7-8}{\lim_{x\to 1^+}\frac{2x^2}{x^2-1}} & \alertNoH{ 7-8}{=} & \fcAnswerUncover{7}{ 8}{\infty} \\%
\displaystyle \alertNoH{ 9-10}{\lim_{x\to 1^-}\frac{2x^2}{x^2-1}} & \alertNoH{ 9-10}{=} & \fcAnswerUncover{7}{ 10}{-\infty} \\%
\displaystyle \alertNoH{ 11-12}{\lim_{x\to -1^+}\frac{2x^2}{x^2-1}} & \alertNoH{ 11-12}{=} & \fcAnswerUncover{7}{ 12}{-\infty} \\%
\displaystyle \alertNoH{ 13-14}{\lim_{x\to -1^-}\frac{2x^2}{x^2-1}} & \alertNoH{ 13-14}{=} & \fcAnswerUncover{7}{ 14}{\infty} %
\end{array}
\]
}%
\uncover<15->{%
...
\begin{array}{|c@{}|c@{}|c@{}|c@{}|}
\hline
& \alertNoH{ 7-8}{-4x} & \alertNoH{ 9-10}{(x^2-1)^2} & \alertNoH{ 11}{f'} \\ \hline
(-\infty , -1) & \fcAnswer{8}{+} & \fcAnswer{10}{+} & \alertNoH{11 }{\uncover<11->{+}} \\
(-1 , 0) & \fcAnswer{8}{+} & \fcAnswer{10}{+} & \alertNoH{ 11}{\uncover<11->{+}} \\
(0 , 1) & \fcAnswer{8}{-} & \fcAnswer{10}{+} & \alertNoH{ 11}{\uncover<11->{-}} \\
(1 , \infty) & \fcAnswer{8}{-} & \fcAnswer{10}{+} & \alertNoH{ 11}{\uncover<11->{-}} \\
\hline
\end{array}
\]
}%
...
&&\uncover<3->{\alertNoH{3,4}{=}} \fcAnswer{ 4}{  \frac{-4(x^2-1)^2+4x\cdot 2(x^2-1)2x}{(x^2-1)^4}}\\%
&&\uncover<5->{=  \frac{12x^2+4}{(x^2-1)^3}}%
\end{eqnarray*}
\uncover<6->{%
\[
\begin{array}{|@{}c@{}|c@{}|c@{}|c@{}|}
...
\hline
(-\infty , -1) & \fcAnswer{8}{+} & \fcAnswerUncover{7}{10}{+} & \alertNoH{ 11}{\uncover<11->{+}} \\
(-1 , 1) & \fcAnswer{8}{+} & \fcAnswerUncover{7}{10}{-} & \alertNoH{ 11}{\uncover<11->{-}} \\
(1 , \infty) & \fcAnswer{8}{+} & \fcAnswerUncover{7}{10}{+} & \alertNoH{ 11}{\uncover<11->{+}} \\
\hline
\end{array}
\]
}%
