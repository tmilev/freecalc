...
\[
\lim\limits_{x\to -\infty} \frac{2x}{\sqrt{x^2+3x+3}-3}= \lim\limits_{x\to - \infty} \frac{2}{\frac{\sqrt{x^2+x+3}}x-\frac3x}=\lim\limits_{x\to - \infty} \frac{2}{-\sqrt{\frac{x^2+3x+3}{x^2}}-\frac3x} =-2\quad . 
\]
