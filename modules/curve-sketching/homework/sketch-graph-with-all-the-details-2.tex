...
\item \input{\freecalcBaseFolder/modules/curve-sketching/homework/sketch-graph-with-all-the-details-2-problem-3}
\item \input{\freecalcBaseFolder/modules/curve-sketching/homework/sketch-graph-with-all-the-details-2-problem-4}
\end{enumerate}
