...
\begin{itemize}
\item \alertNoH{1-7}{keep $\theta, z$ constant, let $r $ vary:} \uncover<7->{\alertNoH{7}{horizontal ray;}}
\item \alertNoH{8-14}{keep $r, z$ constant, let $\theta$ vary:} \uncover<14->{\alertNoH{14}{horizontal circle;}}
\item \alertNoH{15-21}{keep $r, \theta$ constant, let $z$ vary:} \uncover<21->{\alertNoH{21}{ vertical line.}}
\end{itemize}

What surface is traced when:
\begin{itemize}
\item \alertNoH{22,23}{keep $r$ constant, let $\theta, z$ vary:} \uncover<23->{\alertNoH{23}{vertical cylinder;}}
\item \alertNoH{24,25}{keep $\theta$ constant, let $r,z$ vary:} \uncover<25->{\alertNoH{25}{vertical half plane;}}
\item \alertNoH{26,27}{keep $z$ constant, let $r,\theta$ vary:} \uncover<27->{\alertNoH{27}{horizontal plane.}}
\end{itemize}
\uncover<15>{}
\end{columns}
\end{frame}
