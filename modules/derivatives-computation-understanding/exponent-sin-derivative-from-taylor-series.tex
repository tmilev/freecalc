...
\begin{example}
Derive the exponent rule $\left(e^x\right)'=e^x$ using \alert<4>{the power rule $(x^n)'=nx^{n-1}$}, the \alert<3>{\uncover<3->{ \alert<3>{infinite} {\color{gray!50} uniformly convergent series}} sum rule $(f_1+f_2\uncover<3->{ \alert<3>{ +f_3 +\dots}})' =f_1' +f_2' \uncover<3->{ \alert<3>{ +f_3' +\dots}}$} and the Calc II formula
\[
