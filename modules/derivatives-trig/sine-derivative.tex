...
\[
\alert<handout:0| 8-9>{%
\lim_{h\rightarrow 0}\sin x = \uncover<9->{\sin x}%
}%
\qquad %
\alert<handout:0| 10-11>{%
\lim_{h\rightarrow 0}\cos x = \uncover<11->{\cos x}%
}%
\]
}%
\uncover<12->{%
...
\uncover<13->{
From Example 3, p. 69, we think $ \lim_{h\rightarrow 0}\frac{\sin h}{h}$  is  1.}
}%
\end{frame}
