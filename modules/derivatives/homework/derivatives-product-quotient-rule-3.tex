...
\item \input{\freecalcBaseFolder/modules/derivatives/homework/derivatives-product-quotient-rule-3-problem-1}
...
\item \input{\freecalcBaseFolder/modules/derivatives/homework/derivatives-product-quotient-rule-3-problem-4}
\item \input{\freecalcBaseFolder/modules/derivatives/homework/derivatives-product-quotient-rule-3-problem-4-1}
\item $\displaystyle y=\frac{x^3-2x\sqrt{x}}{x}$.

\answer{$2 x- x^{-\frac{1}{2}}$}
\item \input{\freecalcBaseFolder/modules/derivatives/homework/derivatives-product-quotient-rule-3-problem-6}
