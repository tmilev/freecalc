...
There are two variants for solving this problem. The first variant uses indefinite integration and is slightly informal, but easier to apply and remember. The second variant is more rigorous but more difficult to write up. It is our opinion that both solutions should be acceptable for full credit in a Calculus exam. We recommend Variant I for exam taking, and Variant II when writing scientific texts. 
...
\displaystyle \ln \left|\frac{y-1}{y+1}\right|&=& 2t + 2C\\
...
\directionFieldDefault{y y mul 1 sub}{-4}{-4}{0.5}{17}
\end{pspicture}
} %optionalDisplay
