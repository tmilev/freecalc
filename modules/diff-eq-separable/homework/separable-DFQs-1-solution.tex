\solution{\noindent \ref{problemDFQseparable-yprime=ysquared-1-part1}. We proceed as explained in the theory.
...
From the computer generated picture above, we may visually estimate that $y(x)=\frac{1-4 e^{2x} }{1+4 e^{2x} }$ intersects the $x$-axis at $(0, -\frac 35)$. Furthermore, we may check directly that for 
\[
