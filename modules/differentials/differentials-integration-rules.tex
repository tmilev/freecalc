...
\uncover<21->{Corresponding \alert<21>{integration rules}  (studied previously) \uncover<25->{\alert<25>{ Integration rules justified via the Fundamental Theorem of Calculus}}}
