...
\begin{itemize}
\item<8-| alert@8-9> $a^x$ is always \fcAnswer{9}{positive.}  
\item<10-| alert@10-11> $a^0 = \fcAnswer{11}{1}$ for all $a$.  
\end{itemize}
\uncover<12->{For $a > 1$:}
\begin{itemize}
\item<12-| alert@12-13> $\displaystyle \lim_{x\to\infty}a^x = \fcAnswer{13}{\infty.}$
\item<12-| alert@14-15> $\displaystyle \lim_{x\to-\infty}a^x = \fcAnswer{15}{0.}$
\end{itemize}
\uncover<12->{$a < 1$:}
\begin{itemize}
\item<12-| alert@16-17> $\displaystyle \lim_{x\to\infty}a^x = \fcAnswer{17}{0.}$
\item<12-| alert@18-19> $\displaystyle \lim_{x\to-\infty}a^x = \fcAnswer{19}{\infty.}$
\end{itemize}
\end{columns}
