Compute the composite functions $(f\circ g)(x)$, $(g\circ f)(x)$. Simplify your answer to a single fraction. Find the domain of the composite function.
...
\item 
\input{\freecalcBaseFolder/modules/functions-basics/homework/functions-composing-fractional-linear-1-subproblem-6}
\item 
\input{\freecalcBaseFolder/modules/functions-basics/homework/functions-composing-fractional-linear-1-subproblem-7}
\end{enumerate}
