...
\displaystyle \sinh(x) = \frac{e^x-e^{-x}}{2} &\displaystyle  \csch(x)=\frac{1}{\sinh x}\\ [3mm]

\displaystyle \cosh(x) = \frac{e^x+e^{-x}}{2} &\displaystyle  \sech(x)=\frac{1}{\cosh x}\\ [3mm]

\displaystyle \tanh(x) = \frac{\sinh x}{\cosh x} & \displaystyle \coth(x)=\frac{1}{\tanh x}\\
\end{array}
\]
\end{definition}

\textbf{Note:} We postpone inverse hyperbolic trig functions for a later course. 
