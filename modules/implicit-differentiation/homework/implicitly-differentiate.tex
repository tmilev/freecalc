...
\item $\displaystyle  \sqrt{xy}=1+x^2 y$.

\answer{$\begin{array}{rcl}
\frac{\diff y}{\diff x}&=& \frac{2xy-\frac{y}{2\sqrt{xy}}}{\frac{x}{2\sqrt{xy}}-x^2} \\ &=& \begin{array}{l} \frac{4 x y x^{2} y+4 x y- y}{-2 x^{4} y-2 x^{2}+x} \end{array} \end{array}$}
\item $ x\sin y+y\sin x=1$.

\answer{$\frac{\diff y}{\diff x}=\frac{- y \cos{}x- \sin{}y}{x \cos{}y+\sin{}x}$}
\item $\displaystyle  y\cos x=1+\sin (x y)$.

\answer{$\frac{\diff y}{\diff x}=\frac{\cos{}(x y) y+y \sin{}x}{- \cos{}(x y) x+\cos{}x}$}
\item $\displaystyle  \tan (x-y)=\frac{y}{1+x^2}$.
...
\item $\displaystyle 2x^3+x^2y-xy^3=2$.
