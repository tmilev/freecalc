...
&=&\displaystyle x\cos^2 x - \int x2\cos x (-\sin x)\diff x&& \sin (2x)=2\sin x \cos x\\
...
&=&\displaystyle \frac{x}{2}\left(2\cos^2 x - \cos (2x)\right)+ \frac{\sin (2x)}{4}+C &&\cos (2x)=\cos^2x-\sin^2 x \\
&=&\displaystyle \frac{x}{2}\left(2\cos^2x - (\cos^2x-\sin^2x) \right) + \frac{\sin (2x)}{4}+C&&\cos^2x+\sin^2x=1\\
...
\[
\begin{array}{rcll|l}
\displaystyle \int \frac{\ln x}{\sqrt{x}}\diff x&=&\displaystyle \int (\ln x) 2\diff \left(\sqrt{x}\right)&&\text{integrate by parts}\\
