...
\answer{$ \frac12 \left(e^x\sin x - e^x\cos x\right)+C$ }
\item $\displaystyle \int \cos x e^x \diff x$

\answer{$ \frac12 \left(e^x\cos x + e^x\sin x\right)+C$ }
...
\answer{$x(\ln x)^3 -3x(\ln x)^2 +6x\ln {}x-6x+C$}
...
\answer{$\frac{1}{4} x^{2} \sin{}\left(2 x\right)+\frac{1}{4} x \cos{}\left(2 x\right)-\frac{1}{8} \sin{}\left(2 x\right)+\frac{1}{6} x^{3} $}
\end{enumerate}
\end{multicols}
