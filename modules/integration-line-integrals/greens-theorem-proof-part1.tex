...
\vskip -0.2cm
\begin{theorem}[Green]
$\displaystyle\alert<20>{\oint_{\partial D} P \diff x }+ Q \diff y =\alert<20>{ \iint_D} \left( \frac{ \partial Q}{\partial x} \alert<20>{- \frac{ \partial P}{ \partial y}} \right) \alert<20>{\diff x \diff y }\; .$
\end{theorem}
\end{columns}
