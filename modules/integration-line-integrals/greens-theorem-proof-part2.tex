...
\vskip -0.2cm
\begin{theorem}[Green]
$\displaystyle\alert<16>{\oint_{\partial D} }P \diff x + \alert<20>{Q \diff y} = \alert<16>{ \iint_D} \left( \alert<20>{\frac{ \partial Q}{\partial x}} - \frac{ \partial P}{ \partial y} \right) \alert<20>{\diff x \diff y }\; .$
\end{theorem}
\end{columns}
