...
\uncover<2->{\alert<2,3>{The small rectangles have dimensions}} \fcAnswer{3}{ $\frac{4-0}{2} \cdot \frac{2-0}{2} = 2\cdot 1$ and area $2$.} \uncover<4->{\alert<4,5>{The midpoints are}}
\end{columns}
