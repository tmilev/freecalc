...
\rput[l](1.3, 1){$\alertNoH{2}{y=x^2}$}
}
\uncover<3->{
\rput[r](1.2, 2.4){$\alertNoH{2}{y=2x}$}
\psline(-0.2, -0.4)(2.4, 4.8)
}
\uncover<10->{
\fcFullDot{0}{0}
\rput[tl](0.1, -0.1){$\alertNoH{10}{(0,0)}$}
}
\uncover<12->{
\rput[r](1.9, 4){$\alertNoH{12}{(2,4)}$}
\fcFullDot{2}{4}
}
\uncover<15->{
...
\]
\fcQuestion{2}{Plot $y=2x$.} \fcQuestion{4}{ Plot $y=x^2$.} \uncover<6->{\alertNoH{6}{Identify the region. }}
\end{columns}
\only<handout:1|1-18>{
...
\uncover<9->{The \alertNoH{9,10,11,12}{intersection points are} therefore $\alertNoH{9,10}{(0, \fcAnswer{10}{0} )}$ and $\alertNoH{11,12}{(2,\fcAnswer{12}{4})}$.} \uncover<13->{We can plot the function $\frac{1}{8}\left(x^2+y^2\right)$ as above.} \uncover<14->{Our integral is}
}
