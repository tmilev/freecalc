...
\item \input{\freecalcBaseFolder/modules/integration/homework/basic-definite-integrals-1-problem-7}
\item $\displaystyle \int\limits_{1}^{4} \sqrt{ \frac{6 }{x }} \diff x$.

\answer{$\left[2 \sqrt{6} \sqrt{x} \right]_{1}^{4}=2 \sqrt{6} $}
\item \input{\freecalcBaseFolder/modules/integration/homework/basic-definite-integrals-1-problem-9}
...
\item \input{\freecalcBaseFolder/modules/integration/homework/basic-definite-integrals-1-problem-12}
