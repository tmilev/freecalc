...
\item<11->  \alert<handout:0| 11-12>{Length of adjacent side $ = \fcAnswer{12}{\sqrt{3^2-1^2}} \uncover<13->{ = \sqrt{8} = 2\sqrt{2}.}$}
\item<14->  Then \alert<handout:0| 14-15>{$\tan \left(\Arcsin \frac13\right) = \fcAnswer{15}{\frac{1}{2\sqrt{2}}.}$}
\end{itemize}
