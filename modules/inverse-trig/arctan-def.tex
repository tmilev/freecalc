...
\fcYTickWithLabel{-1}{$-1$}
\rput[l](1.6, 2.1){ $\begin{array}{l} y=\tan x\uncover<2->{,}\\ \uncover<2->{-\frac{\pi}{2}< x< \frac{\pi}{2} }\end{array}$
}
\end{pspicture}
...
\item<5->  \alertNoH{5-6}{Domain of $\Arctan$: \fcAnswer{6}{\worksheet{ $(-\infty,\infty)$}.}}
\item<5->  \alertNoH{7-8}{Range of $\Arctan$: \fcAnswer{8}{ \worksheet{$ (- \frac{\pi}{2}, \frac{\pi}{2} )$}.}}
\item<9->  \alertNoH{ 9-10}{$\displaystyle \lim_{x\rightarrow \infty} \Arctan x = \fcAnswer{10}{\worksheet{\frac{\pi}2}.}$}
\item<9->  \alertNoH{ 11-12}{$\displaystyle \lim_{x\rightarrow - \infty} \Arctan x = \fcAnswer{12}{\worksheet{- \frac{\pi}2}.}$}
\end{itemize}
\end{columns}
\end{frame}
