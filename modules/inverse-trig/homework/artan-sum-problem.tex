...
\]
where we use the fact that $\tan (\Arctan w)=w$ for all $w$. We recall that $\Arctan (\tan z)=z$ whenever $z\in \left(-\frac{\pi}{2}, \frac{\pi}{2}\right)$. Now take $\Arctan$ on both sides of the above equation to obtain 
\[
