...
\answer{$ \frac{3}{2}$}
\item \input{\freecalcBaseFolder/modules/limits/homework/limit-x-tends-to-infinity-1-problem-5}
...
\item \input{\freecalcBaseFolder/modules/limits/homework/limit-x-tends-to-infinity-1-problem-9}


\item $\displaystyle \lim\limits_{x\to\infty }\frac{\sqrt{16x^6-3x}}{x^3+2}$.

\answer{$4$}
\item \input{\freecalcBaseFolder/modules/limits/homework/limit-x-tends-to-infinity-1-problem-10}
\item \input{\freecalcBaseFolder/modules/limits/homework/limit-x-tends-to-infinity-1-problem-10-1}
...
\answer{ $2 $.}
\item \input{\freecalcBaseFolder/modules/limits/homework/limit-x-tends-to-infinity-1-problem-14}
