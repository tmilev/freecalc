...
$x^2+2y^2= \only<1-3,5->{a} \only<handout:0|4>{\alertNoH{4}{0}}$\only<handout:0|1-3>{, \alertNoH{5}{$a<0$}}\only<handout:0|5->{, \alertNoH{5}{$a>0$}}.
}
...
\uncover<11->{
\begin{definition}
The sets $\{ (x,y,a)| g(x,y)=a\}$ are called \alertNoH{11}{level curves} of the function $g$.
\end{definition}
}
\end{columns}
