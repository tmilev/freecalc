...
\uncover<3->{Optimization problems are usually not formulated directly in \alert<3>{the above form}.} \uncover<4->{Solving an optimization problem involves the following steps.
\begin{enumerate}
\item<5->  Draw a picture of the problem. Assign variable names to the involved quantities. \uncover<6->{ Determine \alert<6>{which quantity} is being maximized/minimized.}
