...
\fcPatchInScene [colorUV=cyan, colorVU=cyan]{tangentPatchBaseCorner}{tangentPatchSecondCorner}{tangentPatchFirstCorner}
\fcFinishIIIdScene[true]
\fcCurveIIId[linecolor=brown]{0}{360}{theCurvePoint normalUnitV 2 \fcVectorTimesScalar \fcVectorPlusVector tangentUnitV t sin 2 mul \fcVectorTimesScalar normalUnitV t cos -2 mul \fcVectorTimesScalar \fcVectorPlusVector \fcVectorPlusVector}
\only<3->{%
