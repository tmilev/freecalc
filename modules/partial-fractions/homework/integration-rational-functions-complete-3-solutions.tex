...
\[
\frac{x }{2x^{2}+x -1}=\frac{x }{ \left(x +1\right)\left(2x -1\right)}\quad .
\]
We need to find $A_i$'s so that we have the following equality of rational functions. After clearing denominators, we get the following equality. 
