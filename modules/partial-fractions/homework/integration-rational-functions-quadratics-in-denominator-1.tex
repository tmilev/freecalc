...
\answer{$\frac{2}{15} \ln{}\left|x-\frac{2}{ 3} \right| + \frac{ 1}{5} \ln{}\left|x+1\right| +C$}
\item $\displaystyle \int \frac{x }{3x^2+x+2}\diff{}x$

\answer{$\frac{1}{6} \ln{}\left(x^{2}+\frac{1}{3} x+\frac{2}{3}\right)-\frac{\sqrt{23}}{69} \Arctan{}\left(\frac{6}{23}\sqrt{23} x+\frac{\sqrt{23}}{23}\right) +C$}
