...
\]
\uncover<2->{\alertNoH{5-7}{ To find $A$, set \alert<handout:0| 2>{$x=0$};}} \uncover<3->{\alertNoH{8-10}{to find $B$, set \alert<handout:0| 3>{$x=\frac{1}{2}$}; }} \uncover<4->{\alertNoH{11-13}{to find $C$, set \alert<handout:0| 4>{$x=-2$}}.}
