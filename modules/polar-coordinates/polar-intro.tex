...
\rput(0.22, 0.06){$\alertNoH{5}{\theta}$}
}

\uncover<4->{
\fcFullDotBlue{0.866025404}{0.5}
\rput[l](0.88, 0.5){$P\uncover<7->{\alertNoH{7}{(r,\theta)}}$}
}
...
\column{.5\textwidth}
\begin{itemize}
\only<handout:1|1-7>{\item<4->  Let $P$ be a point in the plane.
