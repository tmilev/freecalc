...
\only<1-7>{
\item<6-7> While we can find $x_1, \dots x_n$ with arbitrary precision, \alertNoH{6}{there may not exist a formula involving radicals for computing each $x_1,\dots, x_n$}.
}
\end{itemize}
