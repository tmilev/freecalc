...
Let $h = Ca_1a_2 + pg$. We claim
$
b_1 = a_1 + p C^{-1}sg$, $
b_2=a_2+ pC^{-1}rg$ satisfy the lemma. Ineed, compute:
...
$
\begin{array}{rcll}
C(a_1+p C^{-1}sg)(a_2+pC^{-1}rg)&\equiv& C\left(a_1a_2 + pC^{-1}g\left(s a_2 + r a_1\right)+ p^2C^{-2}g^2rs \right) &\mod p^2\\
&\equiv&Ca_1a_2 + pg\left(s a_2 + r a_1\right) &\mod p^2\\
