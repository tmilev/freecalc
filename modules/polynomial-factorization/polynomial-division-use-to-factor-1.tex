...
\vskip -0.1cm
\begin{example}
Demonstrate that $\alertNoH{2}{6 x^{3}-19 x^{2}+17 x-3}$ is divisible by $\alertNoH{3}{2x-3}$ using polynomial long division. \alertNoH{25,33}{Use your work to factor the cubic.} \alertNoH{34}{Solve the equation $6 x^{3}-19 x^{2}+17 x-3=0$}.
