...
\[
\sum_{n=0}^\infty \frac{\alert<handout:0| 6>{f^{(n)}(3)}}{n!}(x-3)^n = \sum_{n=0}^\infty \frac{\alert<handout:0| 6>{e^3}}{n!}(x-3)^n %= e^3 + \frac{e^3}{1!}(x-3) + \frac{e^3}{2!}(x-3)^2 + \frac{e^3}{3!}(x-3)^3 + \cdots%
\]
}%
\begin{itemize}
