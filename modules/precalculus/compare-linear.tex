...
\begin{frame}
\ \only<handout:0| -1>{%
\includegraphics[height=5cm]{precalculus/pictures/01-02-positivea.pdf}%
}%
\only<handout:0| 2>{%
\includegraphics[height=5cm]{precalculus/pictures/01-02-positiveb.pdf}%
}%
\only<handout:0| 3>{%
\includegraphics[height=5cm]{precalculus/pictures/01-02-positivec.pdf}%
}%
\only<handout:0| 4>{%
\includegraphics[height=5cm]{precalculus/pictures/01-02-positived.pdf}%
}%
\only<5>{%
\includegraphics[height=5cm]{precalculus/pictures/01-02-positivee.pdf}%
}%
