...
\]
where $n$ is a \alertNoH{ 36}{non-negative} \alertNoH{ 24}{integer} and $a_0, \ldots , a_n$ are real numbers, called the coefficients. If $a_n\neq 0$ the integer $n$ is called the degree of $f$.
...
\hline
f(x) &%
\alertNoH{ 3-4,13-14,23-26,35-36}{\text{Polynomial?}} &%
\alertNoH{ 5-6,15-16,27-28}{\text{Degree}} &%
\alertNoH{ 7-8,17-18,29-30}{a_0} &%
\alertNoH{ 9-10,19-20,31,32}{a_1} &%
\alertNoH{ 11-12,21-22,33-34}{a_2} \\
\hline
\alertNoH{ 3-12}{x^4-x+1} &%
\fcAnswer{4}{\text{Yes}}&%
\fcAnswer{6}{4}&%
\fcAnswer{8}{1}&%
\fcAnswer{10}{-1}&%
...
\fcAnswer{20}{0}&%
\fcAnswer{22}{0}\\%
\alertNoH{ 23}{3x^2 - \frac{1}{2}x + \alertNoH{ 24}{\sqrt{x}}} &%
\fcAnswer{24}{\text{No}}&%
&%
&%
&\\
\alertNoH{ 25-34}{3x^2 - \frac{1}{2}x + \sqrt{2}} &%
\fcAnswer{26}{\text{Yes}}&%
\fcAnswer{28}{2}&%
\fcAnswer{30}{\sqrt{2}}&%
\fcAnswer{32}{-\frac{1}{2}}&%
\fcAnswer{34}{3}\\%
\alertNoH{ 35}{3x^2 - \frac{1}{2\alertNoH{ 36}{x}} + \sqrt{2}} &%
\fcAnswer{36}{\text{No}}&%
&%
&%
&\\
