Determine the type of the quadratic surface given by the equation. The answer key has not been proofread, use with extreme caution.
\begin{enumerate}
\item 
...
\answer{(circular) hyperboloid two sheets}
