...
\onlyNoH{17-20}{%
\pstVerb{/angleRefPoint 0 def}%
\fcLineIIId{[0 0 0]}{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul 0]}%
\fcLineIIId{[0 0 0]}{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul theValueOfZ]}%
\fcPerpendicularIIId{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul theValueOfZ]}{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul 0]}{0.3}%
}%
\onlyNoH{17}{%
\fcPutIIId[t]{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul 0] 0.5 \fcVectorTimesScalar}{$2$}%
\fcPutIIId[l]{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul theValueOfZ 0.5 mul]}{$1$}%
}%
\onlyNoH{18}{%
\fcPutIIId[t]{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul 0] 0.5 \fcVectorTimesScalar}{$4$}
\fcPutIIId[l]{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul theValueOfZ 0.5 mul]}{$2$}%
}%
\onlyNoH{19,20}{%
\fcPutIIId[t]{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul 0] 0.5 \fcVectorTimesScalar}{$6$}
\fcPutIIId[l]{[ angleRefPoint cos 2 mul theValueOfZ mul angleRefPoint sin 2 sqrt mul theValueOfZ mul theValueOfZ 0.5 mul] }{$3$}%
}%
\pstVerb{end}
\end{pspicture}
