...
\item<3-| alert@4-5,17>  Given: $\uncover<5->{\frac{\diff V}{\diff t} = 100}$ \uncover<5->{cm$^3$/s.}
\item<3-| alert@6-7>  \alertNoH{15}{Unknown:} \uncover<7->{ \alertNoH{15 }{$ \frac{\diff r}{\diff t}$} \alertNoH{ 18}{when $r = 25$ cm}.}
\end{itemize}
\begin{enumerate}
