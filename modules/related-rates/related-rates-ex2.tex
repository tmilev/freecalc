...
\begin{frame}
\begin{example}
A ladder 10 ft long rests against a vertical wall.  If \alertNoH{ 5}{the bottom of the ladder slides away from the wall at a rate of 1 ft/s}, \alertNoH{ 7}{how fast is the top of the ladder sliding down the wall when the bottom is 6 ft from the wall?}
\begin{columns}[c]
\column{.5\textwidth}
\begin{itemize}
...
\item<3-| alert@6-7> Unknown: \uncover<7->{$\frac{\diff y}{\diff t}$ \alertNoH{ 17}{when $x = 6$ ft}.}
