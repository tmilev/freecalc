...
\[
\begin{array}{rcll|l}
\displaystyle \sum\limits_{n=0}^{\infty}\frac{2^n+5^n}{10^n}&=&\displaystyle  \sum \limits_{ n=0}^{\infty}\left(\frac{1}{5^n}+\frac{1}{2^n}\right)&&\text{use } \sum_{ n= 0}^{\infty} r^n=\frac{1}{1-r}, \text{ for } |r|<1\\
