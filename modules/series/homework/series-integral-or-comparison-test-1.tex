...
\item \input{\freecalcBaseFolder/modules/series/homework/series-integral-or-comparison-test-1-problem-1}
\item \input{\freecalcBaseFolder/modules/series/homework/series-integral-or-comparison-test-1-problem-2}
\item $\displaystyle \sum\limits_{n=1}^{\infty}\frac{n^2+3}{3n^5+n}$

\answer{convergent, can use limit comparison test}
\item \input{\freecalcBaseFolder/modules/series/homework/series-integral-or-comparison-test-1-problem-3}
