...
\uncover<handout:1,3,4|9-11,15-> {\oneBlock{4}{orange}}%
\uncover<handout:1|9-11> {\oneBlockLabel{4}{$\alertNoH{9}{a_4=\frac{1}{2}}$}}%
\uncover<handout:1,3,4|10-11,15->{\oneBlock{5}{orange}}%
...
\item<handout:3-| 15->  Therefore $\sum_{n=1}^\infty \frac{1}{\sqrt{n}}$ is divergent.
\end{itemize}
\end{columns}
\end{frame}
