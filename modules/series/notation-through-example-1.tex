...
\item<26-> In programming, where do we use notation similar to that for $\sum$?
}
...
\item<33-> The pattern should be obvious not only to us, but also to our potential readership.
