...
\newcommand{\theFunOuter}{1 u u mul 2 div sub sqrt\space}%
%\newcommand{\theFunInner}{u \space}%
\newcommand{\theSurface}{%
\fcSurfaceInScene[iterationsU=7, arrows=none]{2 sqrt -1 mul 0.01 add}{0}{2 sqrt 0.01 sub}{30 \fcIterationsV\space mul}{[u v cos \theFunOuter mul v sin \theFunOuter mul]}{}%
