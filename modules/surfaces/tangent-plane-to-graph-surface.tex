...
\alert<4,5>{\fcv{p}(x)}&\alert<4,5>{=}& \alert<4,5>{( x,y_0, f(x,y_0) )} &&&
\uncover<5->{\alert<5>{\fcv p'(x_0)}}& \uncover<5->{ \alert<5>{ =}}& \uncover<5->{\alert<5>{ ( 1,0,f_x(x_0,y_0))}} \\
\alert<6,7>{\fcv q(y)}&\alert<6,7>{=}& \alert<6,7>{ ( x_0,y, f(x_0,y) ) } &&&
\uncover<7->{\alert<7>{ \fcv q'(y_0)}}&\uncover<7->{\alert<7>{=}}& \uncover<7->{\alert<7>{( 0,1,f_y(x_0,y_0))}} \; .
\end{array}
$
\item<8-> Normal to tangent plane at $P$:
$\alert<13>{ \fcv{n} =} \alert<9>{ \fcv{p}'(x_0) }\times \alert<10>{ \fcv q'(y_0)} =  \uncover<9->{\alert<11,12>{ \alert<9>{( 1,0,f_x(x_0,y_0))} \times \alert<10>{( 0,1,f_y(x_0,y_0)) }} } \uncover<11->{ \alert<11,12>{ =}}
\uncover<12->{\alert<12,13,16>{( -f_x(x_0,y_0), -f_y(x_0,y_0), 1 )}} \; .
$
