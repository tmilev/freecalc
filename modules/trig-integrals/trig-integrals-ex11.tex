...
&\uncover<6->{=}& \uncover<6->{ \displaystyle \alertNoH{8,9}{\left( \alertNoH{6}{\frac{\pi}{4} -\frac{\sin \pi}{4}}\right)- \left(\alertNoH{7}{0 -\frac{\sin 0}{4}} \right)} \alertNoH{21}{ \fcQuestion{8}{=} \fcAnswer{9} {\frac{ \pi}{4}}}\quad .}
\end{array}
$
...
\uncover<12->{ \alertNoH{12,13,15}{Set $\alertNoH{17,18} {t = \cos x}$}, $\alertNoH{17}{x\in} \left[\alertNoH{17}{0}, \alertNoH{18} {\frac{ \pi }{ 2}} \right] \uncover<20->{ \alertNoH{20 }{ \Rightarrow \sin x\geq 0} }$.} \uncover<13->{Then $\alertNoH{13,14}{ \alertNoH{16}{\diff t}}=\diff (\cos x) \alertNoH{16}{=} \fcAnswer{14}{ \alertNoH{16 }{ -\sin x \diff x}}$.}
