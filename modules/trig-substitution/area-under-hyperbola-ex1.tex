...
\uncover<handout:4|37->{%
\pscustom*[linecolor=orange!50]{%
...
%\uncover<handout:4|44->{%
%\fcYTickWithLabel{1}{$1$}
%\fcPerpendicular{[0 1]}{[rightX  1] [rightX 0]}{0.2}
%\psline[linecolor=green, linewidth=2pt](! rightX  1)(! rightX 0)
%\rput[l](!rightX 0.1 add 0.5 ){$1$}
%}%
\uncover<handout:4|45>{%
\psline[linecolor=red](0,0)(0,1)(! rightX 0)(0,0)
}%
\uncover<handout:4|45->{%
\psline(0,0)(0,1)(! rightX 0)(0,0)
\rput[r](0,0.5){$1~$}
}%
\uncover<handout:4|46>{%
\psline[linecolor=green, linewidth=2pt](0,0)(0,1)
\psline[linecolor=blue, linewidth=2pt](0,0)(! rightX 0)
}%
\uncover<handout:4|46->{%
\rput(0,1){
\fcAngleBetweenVectors[]{[0 -1]}{[rightX -1]}{0.5}{}
}
\rput (0.4, 0.5){$\theta$}
}%
\uncover<handout:4|47->{%
\rput(! rightX 0){
\fcAngleBetweenVectors[linecolor=blue]{[0 1]}{[rightX -1 mul 1]}{0.5}{}
}
\rput (! rightX 0.4 sub 0.5){$\alertNoH{47}{\theta}$}
}%
...
\only<handout:4|28->{
\begin{itemize}
\item<43-> Recall: integral can be solved via $x=\tan\theta$.
\item<44-> \alertNoH{44-47}{ Geometric interpretation of $\theta$?}
\end{itemize}
}%only<28->
\vfil
} %vbox
