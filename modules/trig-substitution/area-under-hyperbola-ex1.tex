%begin module area-under-hyperbola
...
\displaystyle \uncover<32->{= \left[x\sqrt{x^2+1} \vphantom{\ln (\sqrt{x^2+1}+x)}\right.}\\
\displaystyle \uncover<32->{\left. \ln (\sqrt{x^2+1}+x)\right]^{2\sqrt{2}}_{-2\sqrt{2}}}\\
\uncover<33->{=2\left(2\sqrt{2} \sqrt{(2\sqrt{2})^2+1}\right.} \\
\uncover<33->{\left.+ \ln (\sqrt{(2\sqrt{2})^2+1}+2\sqrt{2}) \right)}\\
\uncover<34->{=12\sqrt{2} +2\ln (3+2\sqrt{2})}\\
\uncover<35->{\approx 20.496}
\end{array}
$
}
\end{columns}
...
%end module area-under-hyperbola