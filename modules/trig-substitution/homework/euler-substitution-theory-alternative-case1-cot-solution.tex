...
\solution{\ref{problemEulerSub-case1-cot(2arctant)-alternative-exposition-radical-via-t}. 

Use Problem \ref{problemEulerSub-case1-cot(2arctant)-alternative-exposition-x-via-t} to get:
\[
