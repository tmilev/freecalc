...
\uncover<2>{\psline[linecolor=blue, linewidth=2pt](! pi 2 div theC sub theB div 0)(! pi 2 div theC sub theB div 1)}%
\uncover<2-5>{%
\psline(! pi 2 div theC sub theB div 0)(! pi 2 div theC sub theB div 1)%
\rput[l](!  pi 2 div theC sub theB div 0.5){~amplitude}%
}%
\uncover<4-5>{%
\fcLengthIndicator[linecolor=green]{theC theB div -1 mul}{-0.2}{pi 2 mul theB div theC theB div -1 mul add}{-0.2}{period}%
