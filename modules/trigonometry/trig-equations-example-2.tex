...
\uncover<26->{ \alertNoH{26-29}{\theta} &\alertNoH{26-29}{ =}& \fcAnswerUncover{26}{29}{ \alertNoH{30}{\frac{2\pi}{3} +2k\pi} \text{ or }  \alertNoH{31}{\frac{4 \pi }{ 3} + 2 k\pi }}} \\
...
\rput[tr](-0.57, -0.05){$ \alertNoH{25}{-\frac{1}{2}}$}%
\fcXTick{-0.5}
}%
