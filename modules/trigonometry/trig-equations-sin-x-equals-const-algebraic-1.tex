...
\only<5,6|handout:0>{%
\parametricplot[linecolor=orange, linewidth=2pt]{0}{60}{t cos t sin}%
}%
\only<7,8|handout:0>{%
\parametricplot[linecolor=orange, linewidth=2pt]{0}{120}{t cos t sin}%
}%
\uncover<9|handout:0>{%
...
\rput[t](3.14, -0.3){$\pi$}
\rput[bl](0.2,1){\tiny $1$}
\only<5,6|handout:0>{\psplot[linewidth=2pt, linecolor=orange]{0}{pi 3 div}{x 57.295779513 mul sin}}%
\only<7,8|handout:0>{\psplot[linewidth=2pt, linecolor=orange]{0}{pi 3 div 2 mul}{x 57.295779513 mul sin}}%
\fcXTickWithLabel{pi 3 div}{$\fcAnswer{6}{\frac{\pi}{3}} $}%
\fcXTickWithLabel{pi 3 div 2 mul}{$\fcAnswer{8}{\frac{2\pi}{3}}$}%
\uncover<2->{%
