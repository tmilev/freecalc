...
\item Given: planes
$\begin{array}{rrcl}
\mathcal{P}_1:&  (\fcv{r} - \fcv{r}_1) \cdot \alertNoH{9}{\fcv{n}_1 }&=& 0 \\
\mathcal{P}_2:& (\fcv{r} - \fcv{r}_2) \cdot \alertNoH{9}{\fcv{n}_2} &=& 0
\end{array}
$
\item Goal: \alertNoH{4}{define} and find the angle between the two planes.
\only<handout:1| 1-6>{%
...
\item<5-> \alertNoH{4}{Define angle $\alpha$} b-n $\mathcal P_1, \mathcal P_2$ = acute angle b-n two perpendiculars.
}%
\item<6-> \alertNoH{6,7}{Consider the plane $\mathcal P_3$ spanned by the two constructed perpendiculars.}
