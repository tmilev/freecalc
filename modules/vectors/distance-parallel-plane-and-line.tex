...
\item The plane and the line \alertNoH{2}{are parallel,} \uncover<2->{i.e. $\fcv{u} \cdot \fcv{n} = 0$.}
...
\uncover<3->{
\alertNoH{1-}{Distance} from $L$ to $\mathcal{P}$:
...
\alertNoH{1-}{ \frac{|( \fcv{r}_1-\fcv{r}_0)\cdot \fcv{n}|}{|\fcv{n}|}}
\end{array}
\]
}
\end{frame}
