...
\begin{theorem}
$\alertNoH{14}{ \alertNoH{13}{ \fcv{orth}_{\fcv u}(\alertNoH{12}{ \fcv v_1 +\fcv v_2}) }= \alertNoH{10}{ \fcv{orth}_{\fcv u} \fcv v_1 } +\alertNoH{11}{\fcv{orth}_{\fcv u} \fcv v_2}}$
\end{theorem}
\begin{proof}
\begin{columns}
\column{0.3\textwidth}
...
\fcPutIIId[rb]{[0 0.5 1]}{$\color{blue}{\alertNoH{14}{ \fcv{orth}_{\fcv u } \fcv v_1}}$}%
}%
...
\fcPutIIId[b]{[0 2 2.2]}{$\color{blue}{\alertNoH{14}{ \fcv{orth}_{\fcv u} \fcv v_2} }$}%
}%
\uncover<13->{%
\fcLineIIId[arrows=->, linecolor=blue]{[0 0 0]}{[0 3 2]}%
\fcPutIIId[l]{[0 2 1.3]}{$\color{blue}{\alertNoH{14}{ \fcv{orth}_{\fcv u} (\fcv v_1 +\fcv v_2)}}$}%
}%
\uncover<12->{%
...
\end{pspicture}
\uncover<9->{\alertNoH{9}{Let $\mathcal P$: plane $\perp \fcv u$.}}
} %uncover
\column{0.7\textwidth}
Algebraic proof:
...
$
\begin{array}{r@{~}c@{~}l}
\fcv{orth}_{\fcv u}(\fcv v_1+\fcv v_2)&=& (\fcv v_1+\fcv v_2)- \alertNoH{3}{\fcv{proj}_{\fcv u}(\fcv v_1 +\fcv v_2)}\\
\uncover<3->{&=&(\alertNoH{4}{\fcv v_1}+\alertNoH{5}{\fcv v_2})\alertNoH{4,5}{-} \left(\alertNoH{3}{ \alertNoH{4}{\fcv{proj}_{\fcv u}(\fcv v_1)} +\alertNoH{5}{\fcv{proj}_{\fcv u}(\fcv v_2)}}\right)} \\
\uncover<4->{&=&\left(\alertNoH{4,6}{\fcv v_1- \fcv{proj}_{\fcv u}(\fcv v_1)}\right)+\left(\alertNoH{5,7}{\fcv v_2-\fcv{proj}_{\fcv u}(\fcv v_2)}\right)}\\
\uncover<6->{&=& \alertNoH{6}{\fcv{orth}_{\fcv u} \fcv v_1}+\alertNoH{7}{\fcv{orth}_{\fcv u} \fcv v_2}}
\end{array}
$
}
\normalsize
