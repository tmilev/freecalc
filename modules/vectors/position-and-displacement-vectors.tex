...
\item<2-> To each displacement vector $(A,B)$, \uncover<3->{assign \alertNoH{3}{position vector} by choosing \alertNoH{3}{origin to be the tail $A$} and giving the position vector by the head $B$.}
...
\uncover<2->{
\rput[tl](1, 0.9){$B$}
\rput[tl](0,-0.1){$\alertNoH{3}{ A\uncover<3->{=O}}$}
