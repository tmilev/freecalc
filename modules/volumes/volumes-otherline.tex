...
\uncover<13->{\alertNoH{13,14}{Cross-section:} \alertNoH{15,16}{a circle centered at \fcAnswerUncover{ 13}{16}{$(x, 1)$}},\\
...
\uncover<4-12>{\pscustom*[linecolor=\fcColorAreaUnderGraph]{%
...
\only<16-21>{\fcPutIIId[lt]{[0.6 0.9 0]}{$(x,1)$}}%
...
\uncover<35->{&=&\displaystyle \pi \left( \frac{32}{5} - 16 + \frac{32}{3} \right) = \frac{16}{15}\pi \quad .}
\end{array}
$
}
\end{columns}
