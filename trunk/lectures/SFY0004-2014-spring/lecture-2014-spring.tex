...
\input{../../modules/course-outline/lecturer}
\input{../../modules/course-outline/homework}
\section{The Chain Rule}
\input{../../modules/chain-rule/chain-rule-intro-alternative}
...
\input{../../modules/chain-rule/chain-rule-twice-ex3}
% end lecture
...
\input{../../modules/chain-rule/chain-rule-e}
...
\input{../../modules/logarithms/exponential-equation3}
\input{../../modules/logarithms/exponential-equation4}
...
\input{../../modules/series/geometric-sum-example}
\input{../../modules/series/geometric-sum-nonstandard}
\input{../../modules/series/arithmetic-sum-indices}
\input{../../modules/series/infinite-geometric}
\input{../../modules/series/infinite-geometric-example}
% end lecture
