...
%\renewcommand{\worksheet}[1]{\uncover<handout:0|1->{#1}}
...
\title[\insertlecture]{\hspace{-1.3cm} {\raisebox{-0.7cm}[0cm][0cm]{ \includegraphics[height =1.2cm]{../University-Logos/UMass-logo-blue.png}}} Math 130}
\subtitle{\insertlecture}
\author[{\raisebox{-0.115cm}{\includegraphics[height=0.4cm]{../University-Logos/UMass-logo-blue.png}}} FreeCalc \\ Math 130]{Greg Maloney \\~\\  Todor Milev}
...
\input{../../modules/trigonometry/trig-equation-basic-ex1}
\input{../../modules/trigonometry/trig-equation-basic-ex2}
}
