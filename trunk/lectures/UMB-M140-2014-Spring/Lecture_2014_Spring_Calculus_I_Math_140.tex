...
\inpute{../../modules/trignometry/trig-functions-unit-circle}
...
\lect{February 3-7, 2014}{Lecture  4}{4}{% begin lecture
...
\lect{February , 2014}{Lecture  5}{5}{%begin lecture
\section{Calculating Limits Using Limit Laws}
...
\lect{February , 2014}{Lecture  6}{6}{% begin lecture
...
\lect{February , 2014}{Lecture 7}{7}{% begin lecture
\section{Limits Involving Infinity}
