...
\title[\insertlecture]{\hspace{-1.3cm} {\raisebox{-0.7cm}[0cm][0cm]{ \includegraphics[height =1.2cm]{../University-Logos/UMass-logo-blue.png}
~
}} Math 140}
\subtitle{\insertlecture}
\author[\raisebox{-0.115cm}{
\includegraphics[height=0.4cm]{../University-Logos/UMass-logo-blue.png}
~
} FreeCalc \\ Math 140]{
\begin{tabular}{c}
Instructors:\\
