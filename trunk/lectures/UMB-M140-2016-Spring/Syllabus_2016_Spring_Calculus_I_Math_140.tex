...
&\counterSubTopic && Functions and function composition (Brief review).  & N/A (lectures only) & Chapter 1.1-1.3 & Section \refBad{secMPSfunctionBasics} &  & 1 \\ 
%Ways to represent a function.
%Some essential functions.
%New functions from old.
&\counterSubTopic && Trigonometry. (Brief review). & N/A(lectures only) & N/A (lectures only)& Section \refBad{secMPStrigonometry}&  & 1  \\\hline
%Angles.
