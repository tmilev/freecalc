...
\section{Integration of Rational Functions} \subsection{Partial fractions}
...
% begin lecture
\lect{February 13, 2014}{Lecture 24-28}{9}{
...
\lect{February 2014}{Lecture 9}{9}{
\section{Integrals of form $\int R(x,\sqrt{ax^2+bx+c}) \diff x$, $R$ - rational function}
\input{../../modules/Euler-substitution/Euler-substitution-intro}
\subsection{Euler substitution}
\input{../../modules/Euler-substitution/Euler-substitution-linear-substitution-preparation}
\input{../../modules/Euler-substitution/Euler-substitution}
...
\input{../../modules/trig-substitution/trig-substitutions-vs-euler-substitutions}
