...
\psaxes[ticks=none, labels=none,#1]{<->}(0,0)(#2,#3)(#4,#5)% \fcLabels[\fcDefaultXLabel][\fcDefaultYLabel]{#3}{#4}%
}%
...
\psline*[linecolor=\fcColorAreaUnderGraph](0,0)%
(! 1 dict begin /t #1\space def theta cos r mul theta sin r mul end)%
