...
[[\fcGetColorCode{\fcColorPatchUV}] [\fcGetColorCode{\fcColorPatchVU}] false true [\fcGetColorCode{black}]] (patch)
] def
/currentContour
[
currentPatch \fcPatchGetContour {[exch true]}forall 
[false [\fcGetColorCode{black}] 1] 
]
def
...
\setkeys{fcGraphics}{#1}%
\pstVerb{%
/theIIIdObjects [theIIIdObjects \fcArrayToStack [#2\space #3\space #4\space (triangle)] ] def%
}%
}
