...
\column{.4\textwidth}
\ \only<-5>{%
\includegraphics[height=5cm]{exponential-functions/natural-exponential-ex7/pictures/07-02-ex7a.pdf}%
}%
\only<6-7>{%
\includegraphics[height=5cm]{exponential-functions/natural-exponential-ex7/pictures/07-02-ex7b.pdf}%
}%
\only<8-9>{%
\includegraphics[height=5cm]{exponential-functions/natural-exponential-ex7/pictures/07-02-ex7c.pdf}%
}%
\only<10-14>{%
\includegraphics[height=5cm]{exponential-functions/natural-exponential-ex7/pictures/07-02-ex7e.pdf}%
}%
\only<15->{%
\includegraphics[height=5cm]{exponential-functions/natural-exponential-ex7/pictures/07-02-ex7f.pdf}%
}%
\column{.6\textwidth}
\begin{itemize}
