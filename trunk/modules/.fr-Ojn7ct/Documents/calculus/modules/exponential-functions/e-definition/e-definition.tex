...
\column{.4\textwidth}
\ \only<-6>{%
\includegraphics[height=4cm]{exponential-functions/e-definition/pictures/07-02-natexpa.pdf}%
}%
\only<7->{%
\includegraphics[height=4cm]{exponential-functions/e-definition/pictures/07-02-natexpb.pdf}%
}%
\column{.6\textwidth}
\begin{itemize}
