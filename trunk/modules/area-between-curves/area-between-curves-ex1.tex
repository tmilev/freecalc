...
\psplot[linecolor=\fcColorGraph, plotpoints=1000]{0}{1}{1 x 2 exp add }
%Function formula: x
\psplot[linecolor=\fcColorGraph, plotpoints=1000]{1}{0}{x}
} %
\rput[r](-0.05,0.5){$x=0$}
\rput[l](1.05,1.5){$x=1$}
} %
...
\rput(1,3){$y=x^{2}+1$}
%Function formula: (x)^{2}+1
\psplot[linecolor=\fcColorGraph, plotpoints=1000]{-0.5}{1.5}{1 x 2 exp add }
}
\only<4->{
\rput[rt](1.5,1){$y=x$}
%Function formula: x
\psplot[linecolor=\fcColorGraph, plotpoints=1000]{-0.47}{1.5}{x}
}
