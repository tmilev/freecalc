...
\uncover<2->{Write $ \sqrt{3}+i$ in polar form: $\alert<2-5,7>{\sqrt{3}+i=} \fcAnswer{3}{2} \left( \cos \left( \uncover<5->{ \alert<5>{\frac{\pi}{6}}} \uncover<2-4>{ \alert<4>{ \textbf{?}}}\right)  +i\cos \left( \uncover<5->{ \alert<5>{\frac{\pi}{6}} } \uncover<2-4>{ \alert<4>{ \textbf{?}}}\right) \right) \uncover<6->{ =\alert<7>{2e^{i\frac{\pi}{6}}}}$. }
