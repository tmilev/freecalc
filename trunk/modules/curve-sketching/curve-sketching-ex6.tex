...
\column{.58\textwidth}
\begin{itemize}
\item<2-| alert@2-3,23-26>  $f'(x) = $ \alertNoH{ 4-5}{\uncover<3->{$4x^3 - 12x^2$} \uncover<4->{$ = $}\uncover<5->{$4\alertNoH{ 11}{x^2}\alertNoH{ 12}{(x-3)}$.}}
\item<2-| alert@6-7,29-34>  \alertNoH{ 13-16}{$f''(x) = $} \alertNoH{ 8-9}{\uncover<7->{\alertNoH{ 13-16}{$12x^2 - 24x$}} \uncover<8->{$ = $} \uncover<9->{$12x(x-2)$.}}
\item<10->  Critical numbers: \uncover<11->{\alertNoH{ 11,21-22}{$0$}} and \uncover<12->{\alertNoH{ 12,17-18}{$3$}.}
\item<13->  \alertNoH{ 13-14,21-22}{$f''(0) = \uncover<14->{0}$} and \alertNoH{ 15-18}{$f''(3) =$ \uncover<16->{$36 > 0$.}}
\item<17->  Second Derivative Test:
\item<17-| alert@17-18>  \alertNoH{ 47-48}{Local \uncover<18->{minimum} at $3$.}  \alertNoH{ 19-20}{\uncover<19->{$f(3) =$ \uncover<20->{$-27$.}}}
\item<22-| alert@22>  No information about $0$.
\item<23->  First Derivative Test:
\item<23->  \alertNoH{ 23-24}{$f'$ is \uncover<24->{$-$} on $(-\infty , 0)$} \alertNoH{ 25-26}{and \uncover<26->{$-$} on $(0, 3)$}.
\item<27->  No local max or min at $0$.
\item<36->  Inflection points: \alertNoH{ 39-40}{$\uncover<39->{(}\uncover<37->{\alertNoH{ 37}{0}}\uncover<39->{,\uncover<40->{0})}$} and \alertNoH{ 41-42}{$\uncover<39->{(}\uncover<38->{\alertNoH{ 38}{2}}\uncover<39->{,\uncover<42->{-16})}$}
\end{itemize}
\end{columns}
\end{example}
\end{frame}
