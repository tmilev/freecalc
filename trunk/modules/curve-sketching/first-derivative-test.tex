...
\item<2->  In the first picture, \alertNoH{2}{$f'(x) > 0$ to the left of $c$} and \alertNoH{2}{$f'(x) < 0$ to the right} of $c$.
\item<3->  In other words, $f'(x)$ changes sign at $c$.
\item<4->  In the second picture, \alertNoH{4}{$f'(x) > 0$ to the left} of $c$ and \alertNoH{4}{$f'(x) > 0$ to the right} of $c$.  $f'(x)$ doesn't change sign at $c$.
...
\psplot[linecolor=\fcColorTangent, plotpoints=1000]{1.7}{2.3}{5.5 x -2 mul add } %Function formula: 2 (x)-1/2
\psplot[linecolor=\fcColorTangent, plotpoints=1000]{0.7}{1.3}{-0.5 x 2 mul add }
\psline[linecolor=\fcColorTangent](1.3,2)(1.7,2)
\psline[linestyle=dashed](1.5, 2)(1.5, 0)
\tiny
\rput[t](1.5, -0.1){$c$}
\rput[l](0.1, 1.6) {\alertNoH{2}{$f'(x)>0$}}
\rput[r](2.9, 1.6) {\alertNoH{2}{$f'(x)<0$}}
\end{pspicture}
...
\psplot[linecolor=\fcColorGraph, plotpoints=1000] {0.73} {2.9} {0.5 x -1.7 add 3 exp add }
%\fcFullDot{1}{0.157}
%\fcFullDot{2.4}{0.843}
%Function formula: -1313/1000+147/100 (x)
\psplot[linecolor=\fcColorTangent, plotpoints=1000] {0.65} {1.35} {x 1.47 mul -1.313 add }
%Function formula: -537/200+147/100 (x)
\psplot[linecolor=\fcColorTangent, plotpoints=1000] {2.05} {2.75} {x 1.47 mul -2.685 add }
\psline[linecolor=\fcColorTangent](1.35,0.492)(2.05,0.492)
\psline[linestyle=dashed](1.7, 0)(1.7, 0.492)
\rput[t](1.7, -0.1){$c$}
\rput(0.5,0.6){\alertNoH{4}{$f'(x)>0$}}
\rput(2.8,0.6){\alertNoH{4}{$f'(x)>0$}}
\end{pspicture}
...
Suppose $f'(c)=0$ (i.e., $f$ is differentiable at $c$ and $c$ is critical number for $f$).
\begin{enumerate}
...
\psplot[linecolor=\fcColorGraph, plotpoints=1000]{0.5}{2.5}{x -1.5 add 2 exp 2 mul 0.5 add }
%Function formula: -3+2 (x)
\psplot[linecolor=\fcColorTangent, plotpoints=1000]{1.7}{2.3}{x 2 mul -3 add }
%Function formula: 3-2 (x)
\psplot[linecolor=\fcColorTangent, plotpoints=1000]{0.7}{1.3}{x -2 mul 3 add }
\psline[linestyle=dashed](1.5, 0.5)(1.5, 0)
\tiny
\rput[t](1.5, -0.1){$c$}
\rput[l](0.1, 0.8) {\alertNoH{3}{$f'(x)<0$}}
\rput[r](2.9, 0.8) {\alertNoH{3}{$f'(x)>0$}}
}
\uncover<handout:3|4->{
%Function formula: (-17/10+x)^{3}+1/2
\psplot[linecolor=\fcColorGraph, plotpoints=1000] {0.73} {2.9} {0.5 x -1.7 add 3 exp add }
...
\psplot[linecolor=\fcColorGraph, plotpoints=1000]{0.5}{2.65}{x -1.7 add 3 exp -1 mul 0.5 add }
%Function formula: 737/200-147/100 (x)
\psplot[linecolor=\fcColorTangent, plotpoints=1000]{2.1}{2.7}{x -1.47 mul 3.685 add }
%Function formula: 2313/1000-147/100 (x)
\psplot[linecolor=\fcColorTangent, plotpoints=1000]{0.7}{1.3}{x -1.47 mul 2.313 add }
\psline[linecolor=\fcColorTangent](1.35,0.492)(2.05,0.492)
