...
\]
\uncover<6->{using \alert<6>{the chain rule},} \uncover<7->{the \alert<7>{the rule $\left(e^{x}\right)'=e^x$},} \uncover<10->{\alert<10>{the constant multiple derivative rule}} \uncover<12->{and \alert<12>{the logarithm derivative rule $(\ln x)'=\frac{1}x$}.}
