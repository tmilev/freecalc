...
\begin{frame}
\begin{example}
Derive the power rule $\alert<13>{\left(x^{\frac{1}{q}}\right)'=\frac{1}{q} x^{\frac{1}q-1}}$ \uncover<4->{using \alert<4>{the rule $(x)'=1$},} \uncover<6->{\alert<6>{the chain rule}} \uncover<7->{and the \alert<7>{integer power rule $\frac{d}{du}(u^q)=qu^{q-1} $}.}
