...
\end{array}
\]
\uncover<2->{\alert<2,8>{using  Euler's formula}, } \uncover<4->{\alert<4,5>{ the exponent derivative rule},} \uncover<4->{\alert<4,5>{the chain rule},} \uncover<6->{\alert<6>{the sum rule}} \uncover<6->{and \alert<6,7>{the constant multiple rule}.} \uncover<5->{\alert<5>{Assume all rules are valid over the complex numbers $\mathbb C$.}}
\[
