...
\answer{$\sin{}(x^{\frac{1}{2}})+\frac{1}{2}x^{\frac{1}{2}} \cos{}(x^{\frac{1}{2}})  $}
...
\answer{$\frac{2 x \cos{}(x) (\sin{}(x))^{2}+2 x^{2} \sin{}(x)  (\cos{}(x))^{2}+x^{2} (\sin{}(x))^{3}}{(\cos{}(x))^{2}} $}
\item $f(x)=\csc x$.

\answer{$ \frac{- \cos{}(x)}{(\sin{}(x))^{2}}$}
\item $f(x)=\sec x$.

\answer{$\frac{\sin{}(x)}{(\cos{}(x))^{2}} $}
\item $f(x)=\cot x$.

\answer{$-\frac{1}{(\sin{}(x))^{2}} $}
\end{enumerate}
\end{multicols}
\end{problem}