...
\uncover<11-18>{\rput[cb](1.6,1.7){$\begin{array}{l}\alertNoH{11,13}{H(1.6,1.6)} \alertNoH{11}{=6.68}\uncover<13->{\alertNoH{13}{ >0}}\end{array} $}}

\uncover<12-18>{\rput[lt](0,-0.4){$\begin{array}{l}\alertNoH{12,13}{H(0,0)} \alertNoH{12}{=-1}\uncover<13->{\alertNoH{13}{<0}}\end{array}$}}
