% begin module transformations-horizontal-stretches-use-sin-as-example
\begin{frame}\ %
\uncover<1->{}
...
\hline
\alertNoH{ 3}{$f(cx)$} &%
\uncover<3->{\alertNoH{ 3}{Compress the graph of $f(x)$ horizontally by a factor of $c$.}} \\%
\alertNoH{ 4}{$f\left(\frac{1}{c}x\right)$} &%
\uncover<4->{\alertNoH{ 4}{Stretch the graph of $f(x)$ horizontally by a factor of $c$.}} \\%
\hline
\end{tabular}
}
\end{frame}
% end module transformations-horizontal-stretches-use-sin-as-example
