...
\psset{xunit=0.3cm, yunit=0.3cm}%due to a bug with caching, the scale of the image should be the same on all uses of the \fcImplicitIId with a particular input.
