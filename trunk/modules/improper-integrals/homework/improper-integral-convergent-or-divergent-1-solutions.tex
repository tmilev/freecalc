...
\]
As the problem asks us to only establish whether the integral is convergent rather than actually produce a numerical value for the integral, we can give a much simpler solution. As the function is even it suffices to show that $\displaystyle \int\limits_0^\infty \frac{x^2}{x^4+2}\diff x$ is convergent.
