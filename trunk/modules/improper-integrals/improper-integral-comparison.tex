...
\begin{enumerate}
\item  \alertNoH{2}{If $\displaystyle \int_a^\infty f(x) \diff x$ is convergent}, then \alertNoH{3}{$\displaystyle \int_a^\infty g(x)\diff x$ is convergent}.
\item \alertNoH{4}{If $\displaystyle \int_a^\infty g(x) \diff x$ is divergent}, \alertNoH{5}{then $\displaystyle \int_a^\infty f(x)\diff x$ is divergent.}
\end{enumerate}
\end{theorem}
\begin{columns}[c]
\column{.4\textwidth}
...
\begin{pspicture}(-0.5, -0.5)(8.6,5.2)%
\psframe*[linecolor=white](-0.5,-0.5)(8.6,5.2)%
\tiny%
