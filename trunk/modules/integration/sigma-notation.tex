...
\begin{frame}
\[
\mathop{\alertNoH{ 2}{\sum}}_{\alertNoH{ 3}{i=1}}^{\alertNoH{ 4}{n}} f(x_i)\Delta x = f(x_1)\Delta x + f(x_2)\Delta x + \cdots + f(x_n)\Delta x
\]
\begin{itemize}
...
\uncover<6->{\alertNoH{ 6-7}{\sum_{i=3}^7 i^2\Delta x}} & \uncover<6->{\alertNoH{ 6-7}{=}}  \uncover<7->{\alertNoH{ 7}{9\Delta x + 16 \Delta x + 25 \Delta x + 36\Delta x + 49\Delta x}}
\end{align*}
\end{example}
}%
\end{frame}
