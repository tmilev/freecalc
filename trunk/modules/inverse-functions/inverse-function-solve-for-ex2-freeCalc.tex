...
\[
\uncover<14->{
f^{-1}( \only<handout:0|14>{y}\only<15->{\alertNoH{15}{x}} )=\frac12\ln\frac{1+\only<handout:0|14>{y}\only<15->{\alertNoH{15}{x}} }{1-\only<handout:0|14>{y}\only<15->{\alertNoH{15}{x}}}
}
\]
\column{0.6\textwidth}
\uncover<2->{Set $u=e^x$.} \uncover<3->{Then $\alertNoH{3}{e^{-x}=} \uncover<4->{\alertNoH{4}{\frac1u}}$.}
\[\begin{array}{rcl}
...
\uncover<10->{u&=& \only<10>{\pm}\only<handout:0|11>{\alertNoH{11}{+}} \sqrt{\frac{1+y}{1-y}}}\\
\uncover<12->{\uncover<13->{x=\ln e^x =}\alertNoH{12}{\ln} u &=& \alertNoH{12}{\ln}\sqrt{\frac{1+y}{1-y}}}\uncover<14->{=\frac12\ln\frac{1+y}{1-y}} \\
\end{array}
\]
