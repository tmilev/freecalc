...
\uncover<1-14>{
\rput(-2,-0.5){$y=f(x)$} 
\psplot[linecolor=\psColorGraph, plotpoints=1000]{-3}{3}{2.71828 x -1 mul exp -1 mul 2.71828 x exp add 2.71828 x exp 2.71828 x -1 mul exp add div }
}
\uncover<15->{
\rput(-2,-0.5){$y=f(x)$} 
...
\psplot[linecolor=\psColorGraph, plotpoints=1000]{-0.994}{0.994}{x 1 add x -1 mul 1 add div ln 0.5 mul }
}
\end{pspicture} 
...
\uncover<10->{u&=& \only<10>{\pm}\only<11>{\alert<11>{+}}\only<12->{\phantom{{+}}} \sqrt{\frac{1+y}{1-y}}}\\
