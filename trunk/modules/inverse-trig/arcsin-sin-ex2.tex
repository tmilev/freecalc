...
\item<3->  \alertNoH{5}{$\sin 2 = \sin a$} for some \alertNoH{6}{$a$ between $-\pi/2$ and $\pi/2$.}
\end{itemize}
\begin{align*}
\uncover<4->{\alertNoH{7}{a - 0} & \alertNoH{7}{= \pi - 2.}} \\
\uncover<5->{\text{Therefore }\quad \Arcsin(\alertNoH{5}{\sin 2}) & = \alertNoH{6}{\Arcsin(\alertNoH{5}{\sin a})}} \\
& \uncover<6->{ \alertNoH{6}{= \alertNoH{7}{a}}} \uncover<7->{\alertNoH{7}{= \pi-2.}}
\end{align*}
...
\uncover<2-| handout:0>{%
\psline[linewidth=0.4pt](2,0.2)(2,-0.2)
\rput[t](2, -0.3){$2$}
}%

\uncover<3-| handout:0>{%
\psline[linewidth=0.4pt](1.141592654,0.2)(1.141592654,-0.2)
