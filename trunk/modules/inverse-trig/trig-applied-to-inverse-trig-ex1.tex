...
\uncover<2->{To simplify $\Arccos y$ we try to use $\cos (\Arccos x) =x $.} \uncover<3->{Therefore our aim is to \alertNoH{7}{rewrite the expression only using the $\cos $ function}.}
\[
