...
\uncover<2->{Equivalent formulation. \alert<3>{For every $\varepsilon>0$}, there exists $\delta>0$ such that \alert<3>{$|f(x)-L|<\varepsilon$} \alert<4>{for all $x$ with} $\alert<5>{0<} \alert<4-5>{|x-a|} \alert<4>{<\delta}$ }
\end{definition}
\begin{center}
...
\rput[l](0.1,1){\tiny $L$}
\uncover<3->{
\psline[linestyle=dotted](-0.5,0.8)(2.5, 0.8)
\psline[linestyle=dotted](-0.5,1.2)(2.5, 1.2)
\psline[linecolor=blue]{<->}(-0.5,0.8)(-0.5,1.2)
\rput[l](-0.4, 1){\tiny $\varepsilon$}
}
