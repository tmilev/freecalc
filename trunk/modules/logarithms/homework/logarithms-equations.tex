...
\item \input{../../modules/logarithms/homework/logarithms-equations-subproblem-13}
\item $e^{4x}+3e^{2x}-4=0$. 
...
\answer{$x=\ln 3$}
\item 
\input{../../modules/logarithms/homework/logarithms-equations-subproblem-16}

\item \input{../../modules/logarithms/homework/logarithms-equations-subproblem-17}
