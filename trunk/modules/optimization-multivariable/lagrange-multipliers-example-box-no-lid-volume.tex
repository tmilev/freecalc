...
\[
\fcAnswer{8}{\langle \alert<11>{yz}, \alert<12>{zx}, \alert<13>{xy} \rangle } \uncover<7->{\alert<7,8>{=}} \alert<7,8>{  \nabla V}= \lambda \alert<9,10>{ \nabla g} \uncover<9->{ \alert<9,10>{ =} \alert<11-13>{\lambda}}  \fcAnswer{10}{ \langle\alert<11>{ 2 z+y},\alert<12>{ 2 z+x}, \alert<13>{2 y+2 x} \rangle\quad .} 
\]
}
