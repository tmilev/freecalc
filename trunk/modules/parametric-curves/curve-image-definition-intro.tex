...
\]
%\begin{center}%use of pspictures in center environment breaks on Ubuntu
...
%\end{center}
\end{columns}
\uncover<2->{Plug in} \uncover<2->{\alertNoH{2}{$ t=0 $}}\uncover<3->{, \alertNoH{3}{$t=0.2$}}\uncover<4->{, \alertNoH{4}{$t = 0.4 $}}\uncover<5->{, \alertNoH{5}{$t = 0.6$}}\uncover<6->{, \alertNoH{6}{$t=0.8$}}\uncover<7->{, \alertNoH{7}{$t = 1$}.}
\uncover<9->{
\begin{question}
