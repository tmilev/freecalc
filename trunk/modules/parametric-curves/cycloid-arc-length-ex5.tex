...
\tiny 
\psaxesStandard{-0.8}{-0.65}{6.8}{2.4}
\psYTickWithLabel{2}{$2\pi r$}
\psXTickWithLabel{6.28319}{$2\pi r$}
%Calculator input: plotCurve{}(- \sin{}t+t, - \cos{}t+1, 0, 2 \pi)
\parametricplot[linecolor=\psColorGraph, plotpoints=1000]{0}{6.28319}{t t 57.29578 mul sin -1 mul add 1 t 57.29578 mul cos -1 mul add }
\end{pspicture} 
