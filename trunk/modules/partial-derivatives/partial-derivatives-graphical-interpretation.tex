...
\begin{pspicture} (-2.1, -2.7)(2.1, 2.3)%
\renewcommand{\fcScreen}{[-1 1 -2] 0}%
\fcBoundingBox{-2.1}{-2.1}{2.1}{2.1}%
\fcStartIIIdScene%
\fcAxesIIIdSymmetricInScene{2}{2}{3}%
\fcSurfaceInScene[arrows=(none), iterationsU=6, iterationsV=6]{-1.2}{-1.2}{1.2}{1.2}{[u v u u mul v v mul sub]}{}%
...
\only<6->{\fcLineIIIdInScene[linewidth=3, linecolor=brown]{[-2 -0.4 0.8 1.6 mul]}{[2 -0.4 -0.8 2.4 mul]}}%
\fcFinishIIIdScene%
\only<6->{%
\only<3->{\fcCurveIIId[linewidth=3pt, linecolor=blue]{-1.4}{1.4}{2 dict begin /u t def /v -0.4 def [u v u u mul v v mul sub] end}}%
