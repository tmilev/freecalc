...
\[
\begin{array}{rcll|l}
\displaystyle \int \frac{x^5}{x^3-1}\diff x&=&\displaystyle \int\left( x^2+\frac{x^2}{x^3-1}\right)\diff x  &&\text{Use polynomial long division }\\
&=&\displaystyle\frac{x^3}{3}+\int \frac{x^2}{(x-1)(x^2+x+1)}\diff x&&\text{Decompose into part. frac.}\\
&=&\displaystyle\frac{x^3}{3}+\int \left(\frac{\frac{1}{3}}{x -1}+\frac{\frac{2}{3}x +\frac{1}{3}}{x^{2}+x +1}\right)\diff x &&\text{complete square in last summand}\\
&=&\displaystyle \frac{x^3}{3}+\frac{1}{3}\ln |x-1|+\frac{2}{3}\int \frac{x+\frac{1}{2}}{\left(x+\frac{1}{2}\right)^2+ \frac{3}{4}}\diff x &&\text{Substitute  } \begin{array}{rcl} u&=&\left(x+\frac{1}{2}\right)^2+ \frac{3}{4}\\\frac{1}{2}\diff u&= &\left(x+\frac{1}{2}\right) \diff x\end{array}\\
