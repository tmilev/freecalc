...
\uncover<2->{\alertNoH{2}{``Theoretical way''} to solve example below: transform to IIa; this \alertNoH{2}{is slow}. } \uncover<3->{ \alertNoH{3}{\textbf{Feel free to skip slide, we will redo in next slide with a shortcut.}}}
\begin{example}
\[
