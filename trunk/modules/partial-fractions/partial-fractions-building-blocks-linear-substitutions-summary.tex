...
\begin{itemize}
\item<2-> We solved building blocks I, II and III \uncover<3->{\alert<3>{in almost complete detail.}}
...
\item<6-> Block IIa, IIIa, linear substitutions: done in full detail. \uncover<7->{\alert<7>{To derive substitution: complete the square.}}
\item<8-> Block IIb, IIIb, linear substitutions: \alert<8>{to derive substitution: again, complete the square;} \uncover<9->{\alert<9>{computations are analogous and we leave them for exercise.}}
\end{itemize}
\end{itemize}
