...
\]
\uncover<2->{\alert<5-7>{ To find $A$, plug in \alert<handout:0| 2>{$0$};}} \uncover<3->{\alert<8-10>{to find $B$, plug in \alert<handout:0| 3>{$\frac{1}{2}$}; }} \uncover<4->{\alert<11-13>{to find $C$, plug in \alert<handout:0| 4>{$-2$}}.}
