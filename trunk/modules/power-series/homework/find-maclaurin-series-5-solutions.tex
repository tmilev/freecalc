...
We solve this problem by using algebraic manipulations and substitutions to reduce it to Problem \ref{problemMaclaurinSeriesln(1-x)}, the  power series expansion $\displaystyle \ln (1-y)=-\sum\limits_{n=1}^\infty \frac{y^n}{n}$ for $|y|<1$.
\[
\begin{array}{rcll|l}
