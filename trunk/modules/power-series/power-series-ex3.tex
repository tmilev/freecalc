...
\end{eqnarray*}
\begin{itemize}
\item<12->  Therefore by the Ratio Test the series \alertNoH{ 12-13}{converges absolutely if \uncover<13->{$|x-3| < 1$}} and \alertNoH{ 14-15}{diverges if \uncover<15->{$|x-3|>1$.}}
\end{itemize}
\abovedisplayskip=0pt
\belowdisplayskip=0pt
\[
