...
It is helpful to picture $f$ and $g$ as machines, and then $f\circ g$ consists of both machines attached end-to-end so that the output of $g$ becomes the input of $f$.
