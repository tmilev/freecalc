...
\only<handout:2| 3>{%
\includegraphics[height=5cm]{precalculus/pictures/01-01-codomain.pdf}
}%
\only<handout:3| 4>{%
...
The set of all possible values taken by $f(x)$ as the element $x$ runs over elements of $E$ is called the range of $f$. 
\end{definition}
}
