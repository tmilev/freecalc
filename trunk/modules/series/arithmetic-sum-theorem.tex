...
\]
\uncover<3->{\alert<3-4>{%
The series contains \uncover<4->{20} terms.  
}}%
\uncover<5->{%
The average of the first and last terms is $\frac{5+100}{2}$.  
}%

\uncover<6->{%
Therefore the sum is $\frac{5+100}{2}\cdot 20  = 105\cdot 10 = 1050.$
}%
\end{example}
}%
