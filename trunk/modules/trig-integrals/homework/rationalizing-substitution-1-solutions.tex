...
&=&\displaystyle \int  \frac{\diff t}{\frac{5}{3} \left( \left( \frac{3}{\sqrt{5}}\left(t + \frac{ 1}{ 3 }\right) \right)^2+1\right)} && \text{Subst.:} 
\begin{array}{r@{~}c@{~}l}w&=& \frac{3}{\sqrt{5}}\left(t + \frac{ 1}{ 3 }\right) \\
&=& \frac{\sqrt{5}}{5}(3t+1)\\
