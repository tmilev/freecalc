...
\psaxesStandardNoFrame{-2.2}{-1.6}{2.2}{1.6} 
...
\displaystyle\uncover<12->{=\alert<12>{4}\int \limits_{{ \alert<12>{0}}}^{a}  b\sqrt{1-\frac{x^2}{a^2}}\diff x} \uncover<12->{.}
\end{array}
$
...
\uncover<1->{=} \displaystyle 4\alert<15>{ \int\limits_{0}^{a}}  b \alert<15>{ \sqrt{1-\frac{x^2}{a^2}}\diff x} \\
\uncover<15->{=4b\alert<15>{ \frac{a\pi}{4}}}\uncover<16->{=\pi a b\quad .}
\end{array}
$
