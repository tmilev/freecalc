...
\uncover<10->{
\rput[b](0, 0.25){$\fcAnswer{11}{\alertNoH{13}{\pi= 180^\circ}}$} 
\rput[t](0.6,-0.6){$\fcAnswer{11}{\alertNoH{12}{ 0^\circ} }$}
...
\uncover<16->{\only<handout:0|18>{\color{green}} \cos\theta &\alertNoH{18}{=} & \alertNoH{18}{ \frac{\alertNoH{16}{1}}{ \alertNoH{17}{ 2} }}}\\
...
\rput[t](0.25, -0.05){$ \alertNoH{18}{\frac{1}{2}}$}%
}%
...
\uncover<21->{\rput[r](-0.15, 0.2){$\alertNoH{21}{ 300^\circ=\frac{5 \pi }{3}} $}}%
\uncover<19->{\fcPerpendicular[linecolor=blue]{[0.5 3 sqrt -2 div]}{[-1 0]}{0.1}}%
\uncover<20->{\fcAngleDegrees[linecolor=purple]{0}{300}{0.2}{}%
\fcFullDot{0.5}{3 sqrt 2 div}%
}%
\uncover<20->{\psline(0,0)(! 0.5 3 sqrt 2 div)}%
\uncover<21->{\rput[l](0.23, 0.2){$\alertNoH{21}{ \frac{\pi}{3}= 60^\circ} $}}%
\end{pspicture}
}
\end{columns}
\end{example}
