...
An expression is rational trigonometric if it is written using $\sin \theta, \cos\theta$ and the four arithmetic operations.
\begin{question}
\alertNoH{1,6}{Is there a general method for proving all rational trigonometric identities in one variable?} 
\end{question}
\only<handout:1|2-5>{
\begin{itemize}
