...
\fcPutIIId[l]{[0 0.5 0.5]}{$~\alertNoH{5}{\fcv{proj}_{\fcv n}(\fcv u)}$}
...
\fcPutIIId[l]{[0.4 -0.5 0.1]}{$\alertNoH{4,5}{ \alpha}$}
...
\end{itemize}
\end{columns}
Line \alertNoH{1-}{perpendicular} to plane
\uncover<2->{
$\Leftrightarrow$
$\fcv{u} \| \fcv{n}$
\uncover<3->{%
...
\uncover<4->{
\alertNoH{1-}{Angle} between line and plane $\alpha$: angle between $L$, $\mathcal{P}$.
$\begin{array}{rcl}
\alertNoH{4,5}{\sin \alpha }&\alertNoH{4,5}{=}& \uncover<5->{\alertNoH{5}{\frac{ \alertNoH{6}{|\fcv{proj}_{\fcv n}\fcv u|}}{|\fcv u|} }}\uncover<6->{ = \frac{ \alertNoH{6}{|\fcv u\cdot\fcv n|} }{ \alertNoH{6}{|\fcv n|} |\fcv u|}}\\
