\begin{frame}
\begin{example}
$\alertNoH{2,3}{( 1,2,3 ) \cdot ( 6,5,4 ) =} \fcAnswer{3}{1 \cdot 6 + 2\cdot 5 + 3 \cdot 4 = 28}$
\end{example}
\end{frame}
...
\[
\uncover<2->{\alertNoH{2,3}{ ( 1,-2,3 ) \cdot ( 1,-1,-1 ) =}} \uncover<3->{\alertNoH{3}{1\cdot 1 + (-1)\cdot (-2)+ 3\cdot (-1)=0}},
\]
