...
\fcPutIIId[tl]{[0.25 -0.1 0.5]}{$ \alertNoH{5}{\fcv u}$}
...
\column{0.6\textwidth}
\begin{itemize}
\item Given: line $L: \quad\alertNoH{6}{ \fcv{r}= \fcv{r}_1+t\fcv{u}}$,
\item $\fcv r_1=( x_1, y_1, z_1)$, $u=( p,q,r)$,
\item plane $\mathcal{P}: \alertNoH{12}{\alertNoH{4}{ax +by +cz} \alertNoH{5}{ -d}=0}$.
...
$
\alertNoH{12}{( \alertNoH{4,7}{\fcv r}\alertNoH{5,8}{-\fcv r_0})\alertNoH{4,5,8}{\cdot \fcv n}=0}.
$
} %uncover3
\uncover<6->{A point $P(\fcv r) $ \alertNoH{6}{on the line} is of the form $\alertNoH{6,7}{\fcv r=\fcv r_1+t\fcv u}$,} \uncover<7->{therefore $P$ lies on both the line and the plane if:
\[\begin{array}{rcl}
(\alertNoH{7}{ \fcv{r}_1+t\fcv{u}}-\alertNoH{8}{\fcv{r}_0})\alertNoH{8}{ \cdot \fcv{n} }&=& 0\\
...
\uncover<11->{\fcv r&= &\fcv r_1-\frac{\alertNoH{12}{(\fcv{r}_1-\fcv r_0)\cdot\fcv  n}}{\fcv u \cdot \fcv n}\fcv u }\\
\uncover<12->{&=& ( x_1, y_1, z_1 )-\frac{\alertNoH{12}{ ax_1 +by_1+cz_1-d}}{ap + bq +cr }( p,q, r)}
\end{array}
\]
}
\end{frame}
