...
$
\alertNoH{2}{\fcv{r} =}\uncover<3->{\alertNoH{3}{( 1,2,3) + t ( 4,5,6) \leftrightarrow \fcv{r} = ( 1+4t, 2+5t, 3+6t)}}
$
} %uncover
...
\left|
\begin{array}{rl}
\alertNoH{4}{x =}& \uncover<5->{\alertNoH{4}{ 1 + 4t}} \\
\alertNoH{4}{y =}& \uncover<5->{\alertNoH{4}{2+5t}} \\
\alertNoH{4}{z =}& \uncover<5->{\alertNoH{4}{3+6t}}
\end{array}
\right. , \quad t \text{ real number.}
$
} %uncover

\uncover<6->{ \alertNoH{6}{Symmetric equations:}
\uncover<7->{
