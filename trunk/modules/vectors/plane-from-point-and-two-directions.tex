...
\uncover<5->{\alert<1->{Implicit vectorial equation}: $P(\fcv{r}) \text{ is on } \mathcal{P} \Longleftrightarrow (\fcv{r}-\fcv{r}_0) \cdot \fcv{n} = 0$}
...
\uncover<10->{%
\alert<1->{Parametric vectorial equation}: 
